...
CREATE (0)-[:Point]->(type),
(0)-[:4326> POINT (14.716667 48.166667)]->(asWKT),
(0)-[:Kastell Wallsee Geometry]->(label),
(4)-[:Watchtower]->(type),
(4)-[:c589a7d3-f71c-4051-ac8b-c701902d3610_geom]->(hasGeometry),
(4)-[:Straßenstation Maria Gugging]->(label),
(8)-[:Burgus]->(type),
(8)-[:5028c3bd-efbb-43b3-a8f6-a30ab9844d1b_geom]->(hasGeometry),
(8)-[:Blashauskapelle]->(label),
(12)-[:Burgus]->(type),
(12)-[:8135cb6b-504d-4cae-9835-b9a7b0613163_geom]->(hasGeometry),
(12)-[:Burgus Ybbs]->(label),
(15)-[:Point]->(type),
(15)-[:4326> POINT (15.331111 48.228333)]->(asWKT),
(15)-[:Kastell Melk Geometry]->(label),
(18)-[:Watchtower]->(type),
(18)-[:c2b75037-aed0-49b4-9e1c-39944efa5cb4_geom]->(hasGeometry),
(18)-[:Wachturm Säusenstein]->(label),
(22)-[:Point]->(type),
(22)-[:4326> POINT (14.190556 48.323889)]->(asWKT),
(22)-[:Burgus Hirschleitengraben Geometry]->(label),
(25)-[:Burgus]->(type),
(25)-[:c75941f8-009d-4c4c-8505-0298a88a6fd4_geom]->(hasGeometry),
(25)-[:Burgus Hollenburg]->(label),
(28)-[:Point]->(type),
(28)-[:4326> POINT (14.716667 48.166667)]->(asWKT),
(28)-[:Burgus Wallsee-Nordhang Geometry]->(label),
(30)-[:Watchtower]->(type),
(30)-[:88218e4a-aa6a-421c-84ea-a646790b80cb_geom]->(hasGeometry),
(30)-[:Wachturm Kobling-Rossgraben]->(label),
(33)-[:Kleinkastell]->(type),
(33)-[:51607531-4767-41c1-94ca-86d68572c7c2_geom]->(hasGeometry),
(33)-[:Kleinkastell Sankt Marienkirchen]->(label),
(37)-[:Point]->(type),
(37)-[:4326> POINT (15.066667 48.166667)]->(asWKT),
(37)-[:Burgus Neumarkt Geometry]->(label),
(40)-[:Point]->(type),
(40)-[:4326> POINT (13.916667 48.416667)]->(asWKT),
(40)-[:Wachturm Kobling See Geometry]->(label),
(43)-[:Point]->(type),
(43)-[:4326> POINT (14.475 48.216667)]->(asWKT),
(43)-[:Lauriacum Geometry]->(label),
(46)-[:MilitaryCamp]->(type),
(46)-[:d0ef2a62-6c85-44ce-a995-65ab6d5a5f43_geom]->(hasGeometry),
(46)-[:Kastell Boiotro]->(label),
(50)-[:MilitaryCamp]->(type),
(50)-[:9f8f4e96-12d9-449b-b9ab-6e6080e34c9f_geom]->(hasGeometry),
(50)-[:Kastell Boiodurum ]->(label),
(53)-[:Point]->(type),
(53)-[:4326> POINT (15.2 48.2)]->(asWKT),
(53)-[:Kastell Arelape Geometry]->(label),
(56)-[:Point]->(type),
(56)-[:4326> POINT (15.066667 48.166667)]->(asWKT),
(56)-[:Burgus Ybbs Geometry]->(label),
(58)-[:Point]->(type),
(58)-[:4326> POINT (15.913889 48.3425)]->(asWKT),
(58)-[:Wachturm Maria Ponsee West Geometry]->(label),
(61)-[:MilitaryCamp]->(type),
(61)-[:78b044f5-8a10-47ed-acf0-74658affbf22_geom]->(hasGeometry),
(61)-[:Kastell Lentia]->(label),
(65)-[:Point]->(type),
(65)-[:4326> POINT (15.577639 48.39375)]->(asWKT),
(65)-[:Kastell Favianis Geometry]->(label),
(68)-[:Point]->(type),
(68)-[:4326> POINT (14.798056 48.095556)]->(asWKT),
(68)-[:Locus Felicis Geometry]->(label),
(71)-[:Point]->(type),
(71)-[:4326> POINT (14.290556 48.303056)]->(asWKT),
(71)-[:Kastell Lentia Geometry]->(label),
(74)-[:Burgus]->(type),
(74)-[:ed3e59f2-e683-4800-9e27-92d82cbc867f_geom]->(hasGeometry),
(74)-[:Burgus Neumarkt]->(label),
(76)-[:Point]->(type),
(76)-[:4326> POINT (14.033333 48.316667)]->(asWKT),
(76)-[:Kastell Eferding Geometry]->(label),
(79)-[:Point]->(type),
(79)-[:4326> POINT (15.913889 48.3425)]->(asWKT),
(79)-[:Kastell Zwentendorf Geometry]->(label),
(81)-[:Point]->(type),
(81)-[:4326> POINT (16.249167 48.3125)]->(asWKT),
(81)-[:Straßenstation Maria Gugging Geometry]->(label),
(84)-[:Point]->(type),
(84)-[:4326> POINT (13.498611 48.574444)]->(asWKT),
(84)-[:Burgus Passau-Haibach Geometry]->(label),
(87)-[:Point]->(type),
(87)-[:4326> POINT (14.716667 48.166667)]->(asWKT),
(87)-[:Burgus Sommerau Geometry]->(label),
(89)-[:Point]->(type),
(89)-[:4326> POINT (13.462222 48.569722)]->(asWKT),
(89)-[:Kastell Boiotro Geometry]->(label),
(92)-[:Point]->(type),
(92)-[:4326> POINT (13.916667 48.416667)]->(asWKT),
(92)-[:Wachturm Kobling-Rossgraben Geometry]->(label),
(94)-[:Point]->(type),
(94)-[:4326> POINT (15.116667 48.2)]->(asWKT),
(94)-[:Wachturm Sarling Geometry]->(label),
(97)-[:Point]->(type),
(97)-[:4326> POINT (15.913889 48.3425)]->(asWKT),
(97)-[:Wachturm Maria Ponsee Süd Geometry]->(label),
(99)-[:MilitaryCamp]->(type),
(99)-[:b3e7d110-127b-45a7-9195-5e8a694e4862_geom]->(hasGeometry),
(99)-[:Kastell Arelape]->(label),
(101)-[:Class]->(type),
(101)-[:Limes]->(subClassOf),
(101)-[:Kleinkastell]->(label),
(105)-[:MilitaryCamp]->(type),
(105)-[:0e8a5ba3-887e-4540-92c3-d35fef2bd579_geom]->(hasGeometry),
(105)-[:Kastell Eferding]->(label),
(107)-[:Point]->(type),
(107)-[:4326> POINT (15.331111 48.228333)]->(asWKT),
(107)-[:Burgus Melk-Spielberg Geometry]->(label),
(109)-[:Watchtower]->(type),
(109)-[:4043d889-d9be-47b7-b9d3-afede593d67a_geom]->(hasGeometry),
(109)-[:Wachturm Sarling]->(label),
(111)-[:Point]->(type),
(111)-[:4326> POINT (13.916667 48.416667)]->(asWKT),
(111)-[:Kleinkastell Schlögen Geometry]->(label),
(113)-[:Watchtower]->(type),
(113)-[:ed6779f9-6afd-4f34-b7ff-0a6e731d4846_geom]->(hasGeometry),
(113)-[:Wachturm Freinberg ]->(label),
(116)-[:Burgus]->(type),
(116)-[:71192446-c179-4a45-9214-44ef9a3a996b_geom]->(hasGeometry),
(116)-[:Burgus Bacharnsdorf]->(label),
(120)-[:Point]->(type),
(120)-[:4326> POINT (16.177083 48.328972)]->(asWKT),
(120)-[:Kastell Cannabiaca Geometry]->(label),
(123)-[:MilitaryCamp]->(type),
(123)-[:cfcfa4b0-501f-4563-8157-3c76054014a4_geom]->(hasGeometry),
(123)-[:Kastell Favianis]->(label),
(125)-[:Point]->(type),
(125)-[:4326> POINT (15.116667 48.2)]->(asWKT),
(125)-[:Wachturm Säusenstein Geometry]->(label),
(128)-[:Burgus]->(type),
(128)-[:48f27058-f4ea-41f3-8319-888f59ffdd2d_geom]->(hasGeometry),
(128)-[:Burgus Au-Rotte Hof]->(label),
(131)-[:MilitaryCamp]->(type),
(131)-[:8f964055-7a95-4e88-bcef-5bd3a5824de9_geom]->(hasGeometry),
(131)-[:Kastell Cannabiaca]->(label),
(133)-[:Burgus]->(type),
(133)-[:58660c1d-c211-4cf7-90d6-b53a5957addc_geom]->(hasGeometry),
(133)-[:Burgus St. Lorenz]->(label),
(136)-[:MilitaryCamp]->(type),
(136)-[:0f5c8dda-88a9-48ad-bf8f-e72f216a4066_geom]->(hasGeometry),
(136)-[:Kastell Zwentendorf]->(label),
(138)-[:Burgus]->(type),
(138)-[:a41296e5-fca2-4ce3-843e-a17871a5d85b_geom]->(hasGeometry),
(138)-[:Burgus Wallsee-Nordhang]->(label),
(140)-[:FeatureCollection]->(type),
(140)-[:a41296e5-fca2-4ce3-843e-a17871a5d85b]->(member),
(140)-[:b3e7d110-127b-45a7-9195-5e8a694e4862]->(member),
(140)-[:c2b75037-aed0-49b4-9e1c-39944efa5cb4]->(member),
(140)-[:c589a7d3-f71c-4051-ac8b-c701902d3610]->(member),
(140)-[:c75941f8-009d-4c4c-8505-0298a88a6fd4]->(member),
(140)-[:cb7b6f3a-395f-48b6-a6e3-247e6c5a2ff5]->(member),
(140)-[:cfcfa4b0-501f-4563-8157-3c76054014a4]->(member),
(140)-[:d0ef2a62-6c85-44ce-a995-65ab6d5a5f43]->(member),
(140)-[:d151609e-cb90-4faf-a74b-54d2f52e01a1]->(member),
(140)-[:d8bcb543-3948-43fd-937b-2782138b9deb]->(member),
(140)-[:ec211670-f0d2-4c53-b8a5-3b8830b0aaa1]->(member),
(140)-[:ed3e59f2-e683-4800-9e27-92d82cbc867f]->(member),
(140)-[:ed6779f9-6afd-4f34-b7ff-0a6e731d4846]->(member),
(140)-[:0a1032df-bf53-47e7-9da6-e56c2b97caa8]->(member),
(140)-[:0e8a5ba3-887e-4540-92c3-d35fef2bd579]->(member),
(140)-[:0f5c8dda-88a9-48ad-bf8f-e72f216a4066]->(member),
(140)-[:1d31fa5a-61cc-42df-b958-a5e9d83555a3]->(member),
(140)-[:130bed48-35dd-45d9-9fc0-bc50fb465c60]->(member),
(140)-[:13572025-f4dc-4503-8aad-72050202752b]->(member),
(140)-[:2bf44917-dd67-4ec8-9240-513476cdb60c]->(member),
(140)-[:2e2c9ca5-61d1-459e-a151-fad5d81dd1b7]->(member),
(140)-[:203478fb-4a78-48c7-bd75-97b667f6e707]->(member),
(140)-[:2471711a-fb59-436f-ade5-b61e4fd67732]->(member),
(140)-[:26f3beb0-0cb4-42a8-849d-38455b2d1b79]->(member),
(140)-[:32371ca3-a871-475e-8d85-49ca8c26da3d]->(member),
(140)-[:4c745423-da08-4414-93b9-bf0df2382c76]->(member),
(140)-[:4043d889-d9be-47b7-b9d3-afede593d67a]->(member),
(140)-[:48f27058-f4ea-41f3-8319-888f59ffdd2d]->(member),
(140)-[:5028c3bd-efbb-43b3-a8f6-a30ab9844d1b]->(member),
(140)-[:51607531-4767-41c1-94ca-86d68572c7c2]->(member),
(140)-[:58660c1d-c211-4cf7-90d6-b53a5957addc]->(member),
(140)-[:64755b3a-9ff6-4c12-b9fb-778e3bde5b1f]->(member),
(140)-[:7e23ed9a-8efc-48ec-a294-a7cc9b8285dc]->(member),
(140)-[:71192446-c179-4a45-9214-44ef9a3a996b]->(member),
(140)-[:78b044f5-8a10-47ed-acf0-74658affbf22]->(member),
(140)-[:8f964055-7a95-4e88-bcef-5bd3a5824de9]->(member),
(140)-[:80943cf4-f263-44f2-bd49-2a2c405b3be6]->(member),
(140)-[:8135cb6b-504d-4cae-9835-b9a7b0613163]->(member),
(140)-[:88218e4a-aa6a-421c-84ea-a646790b80cb]->(member),
(140)-[:9f8f4e96-12d9-449b-b9ab-6e6080e34c9f]->(member),
(140)-[:Limes Noricum Features]->(label),
(161)-[:MilitaryCamp]->(type),
(161)-[:d8bcb543-3948-43fd-937b-2782138b9deb_geom]->(hasGeometry),
(161)-[:Kastell Wallsee]->(label),
(163)-[:Burgus]->(type),
(163)-[:4c745423-da08-4414-93b9-bf0df2382c76_geom]->(hasGeometry),
(163)-[:Burgus Sommerau]->(label),
(165)-[:Point]->(type),
(165)-[:4326> POINT (13.428333 48.378611)]->(asWKT),
(165)-[:Kleinkastell Sankt Marienkirchen Geometry]->(label),
(168)-[:Point]->(type),
(168)-[:4326> POINT (15.680278 48.38)]->(asWKT),
(168)-[:Burgus Hollenburg Geometry]->(label),
(172)-[:Kleinkastell]->(type),
(172)-[:80943cf4-f263-44f2-bd49-2a2c405b3be6_geom]->(hasGeometry),
(172)-[:Kleinkastell Schlögen]->(label),
(174)-[:GeometryCollection]->(type),
(174)-[:a41296e5-fca2-4ce3-843e-a17871a5d85b_geom]->(member),
(174)-[:b3e7d110-127b-45a7-9195-5e8a694e4862_geom]->(member),
(174)-[:c75941f8-009d-4c4c-8505-0298a88a6fd4_geom]->(member),
(174)-[:cfcfa4b0-501f-4563-8157-3c76054014a4_geom]->(member),
(174)-[:d0ef2a62-6c85-44ce-a995-65ab6d5a5f43_geom]->(member),
(174)-[:d151609e-cb90-4faf-a74b-54d2f52e01a1_geom]->(member),
(174)-[:d8bcb543-3948-43fd-937b-2782138b9deb_geom]->(member),
(174)-[:ec211670-f0d2-4c53-b8a5-3b8830b0aaa1_geom]->(member),
(174)-[:ed3e59f2-e683-4800-9e27-92d82cbc867f_geom]->(member),
(174)-[:0a1032df-bf53-47e7-9da6-e56c2b97caa8_geom]->(member),
(174)-[:0e8a5ba3-887e-4540-92c3-d35fef2bd579_geom]->(member),
(174)-[:0f5c8dda-88a9-48ad-bf8f-e72f216a4066_geom]->(member),
(174)-[:130bed48-35dd-45d9-9fc0-bc50fb465c60_geom]->(member),
(174)-[:13572025-f4dc-4503-8aad-72050202752b_geom]->(member),
(174)-[:2bf44917-dd67-4ec8-9240-513476cdb60c_geom]->(member),
(174)-[:2e2c9ca5-61d1-459e-a151-fad5d81dd1b7_geom]->(member),
(174)-[:203478fb-4a78-48c7-bd75-97b667f6e707_geom]->(member),
(174)-[:26f3beb0-0cb4-42a8-849d-38455b2d1b79_geom]->(member),
(174)-[:32371ca3-a871-475e-8d85-49ca8c26da3d_geom]->(member),
(174)-[:4c745423-da08-4414-93b9-bf0df2382c76_geom]->(member),
(174)-[:48f27058-f4ea-41f3-8319-888f59ffdd2d_geom]->(member),
(174)-[:5028c3bd-efbb-43b3-a8f6-a30ab9844d1b_geom]->(member),
(174)-[:51607531-4767-41c1-94ca-86d68572c7c2_geom]->(member),
(174)-[:58660c1d-c211-4cf7-90d6-b53a5957addc_geom]->(member),
(174)-[:64755b3a-9ff6-4c12-b9fb-778e3bde5b1f_geom]->(member),
(174)-[:71192446-c179-4a45-9214-44ef9a3a996b_geom]->(member),
(174)-[:78b044f5-8a10-47ed-acf0-74658affbf22_geom]->(member),
(174)-[:8f964055-7a95-4e88-bcef-5bd3a5824de9_geom]->(member),
(174)-[:80943cf4-f263-44f2-bd49-2a2c405b3be6_geom]->(member),
(174)-[:8135cb6b-504d-4cae-9835-b9a7b0613163_geom]->(member),
(174)-[:9f8f4e96-12d9-449b-b9ab-6e6080e34c9f_geom]->(member),
(174)-[:Limes Noricum Geometries]->(label),
(182)-[:Limes]->(type),
(182)-[:2e2c9ca5-61d1-459e-a151-fad5d81dd1b7_geom]->(hasGeometry),
(182)-[:Locus Felicis]->(label),
(184)-[:Point]->(type),
(184)-[:4326> POINT (14.190556 48.323889)]->(asWKT),
(184)-[:Wachturm Freinberg Geometry]->(label),
(186)-[:Point]->(type),
(186)-[:4326> POINT (15.445069 48.369328)]->(asWKT),
(186)-[:Burgus St. Lorenz Geometry]->(label),
(190)-[:MilitaryCamp]->(type),
(190)-[:13572025-f4dc-4503-8aad-72050202752b_geom]->(hasGeometry),
(190)-[:Kastell Melk]->(label),
(192)-[:Burgus]->(type),
(192)-[:130bed48-35dd-45d9-9fc0-bc50fb465c60_geom]->(hasGeometry),
(192)-[:Burgus Melk-Spielberg]->(label),
(195)-[:Point]->(type),
(195)-[:4326> POINT (13.423611 48.38)]->(asWKT),
(195)-[:Militärziegelei Sankt Marienkirchen Geometry]->(label),
(198)-[:Burgus]->(type),
(198)-[:26f3beb0-0cb4-42a8-849d-38455b2d1b79_geom]->(hasGeometry),
(198)-[:Burgus Passau-Haibach]->(label),
(200)-[:Burgus]->(type),
(200)-[:0a1032df-bf53-47e7-9da6-e56c2b97caa8_geom]->(hasGeometry),
(200)-[:Burgus Hirschleitengraben]->(label),
(202)-[:Point]->(type),
(202)-[:4326> POINT (15.445069 48.369328)]->(asWKT),
(202)-[:Burgus Bacharnsdorf Geometry]->(label),
(204)-[:Limes]->(type),
(204)-[:32371ca3-a871-475e-8d85-49ca8c26da3d_geom]->(hasGeometry),
(204)-[:Lauriacum]->(label),
(206)-[:Burgus]->(type),
(206)-[:ec211670-f0d2-4c53-b8a5-3b8830b0aaa1_geom]->(hasGeometry),
(206)-[:Burgus Rossatz]->(label),
(208)-[:Point]->(type),
(208)-[:4326> POINT (15.733056 48.333333)]->(asWKT),
(208)-[:Legionslager Albing Geometry]->(label),
(211)-[:Point]->(type),
(211)-[:4326> POINT (15.445069 48.369328)]->(asWKT),
(211)-[:Burgus Rossatz Geometry]->(label),
(213)-[:Point]->(type),
(213)-[:4326> POINT (15.733056 48.333333)]->(asWKT),
(213)-[:Kastell Augustianis Geometry]->(label),
(216)-[:Point]->(type),
(216)-[:4326> POINT (14.716667 48.166667)]->(asWKT),
(216)-[:Burgus Au-Rotte Hof Geometry]->(label),
(218)-[:Point]->(type),
(218)-[:4326> POINT (13.773667 48.471506)]->(asWKT),
(218)-[:Kleinkastell Eberranna Geometry]->(label),
(221)-[:Point]->(type),
(221)-[:4326> POINT (15.331111 48.228333)]->(asWKT),
(221)-[:Blashauskapelle Geometry]->(label),
(223)-[:MilitaryCamp]->(type),
(223)-[:d151609e-cb90-4faf-a74b-54d2f52e01a1_geom]->(hasGeometry),
(223)-[:Kastell Comagena]->(label),
(225)-[:Limes]->(type),
(225)-[:7e23ed9a-8efc-48ec-a294-a7cc9b8285dc_geom]->(hasGeometry),
(225)-[:Militärziegelei Sankt Marienkirchen]->(label),
(227)-[:Point]->(type),
(227)-[:4326> POINT (16.052083 48.331056)]->(asWKT),
(227)-[:Kastell Comagena Geometry]->(label),
(230)-[:Point]->(type),
(230)-[:4326> POINT (13.47585 48.57125)]->(asWKT),
(230)-[:Kastell Boiodurum Geometry]->(label),
(233)-[:Watchtower]->(type),
(233)-[:cb7b6f3a-395f-48b6-a6e3-247e6c5a2ff5_geom]->(hasGeometry),
(233)-[:Wachturm Maria Ponsee Süd]->(label),
(236)-[:Watchtower]->(type),
(236)-[:2471711a-fb59-436f-ade5-b61e4fd67732_geom]->(hasGeometry),
(236)-[:Wachturm Kobling See]->(label),
(238)-[:Watchtower]->(type),
(238)-[:1d31fa5a-61cc-42df-b958-a5e9d83555a3_geom]->(hasGeometry),
(238)-[:Wachturm Maria Ponsee West]->(label),
(240)-[:MilitaryCamp]->(type),
(240)-[:2bf44917-dd67-4ec8-9240-513476cdb60c_geom]->(hasGeometry),
(240)-[:Kastell Augustianis]->(label),
(242)-[:LegionaryCamp]->(type),
(242)-[:64755b3a-9ff6-4c12-b9fb-778e3bde5b1f_geom]->(hasGeometry),
(242)-[:Legionslager Albing]->(label),
(245)-[:Kleinkastell]->(type),
(245)-[:203478fb-4a78-48c7-bd75-97b667f6e707_geom]->(hasGeometry),
(245)-[:Kleinkastell Eberranna]->(label)
