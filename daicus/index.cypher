...
(29)-[:LegionaryCamp]->(type),
(29)-[:7e6b0abd-392e-48da-a973-52db57e43459_geom]->(hasGeometry),
(29)-[:Legionslager]->(comment),
(29)-[:Kastell Berzovia ]->(label),
(34)-[:LegionaryCamp]->(type),
(34)-[:497eff64-e309-4704-b5f0-3e2872ff379d_geom]->(hasGeometry),
(34)-[:Legionslager]->(comment),
(34)-[:Legionslager Potaissa]->(label),
(37)-[:Point]->(type),
(37)-[:4326> POINT (24.752103 46.239431)]->(asWKT),
(37)-[:Kastell Sighisoara Geometry]->(label),
(40)-[:MilitaryCamp]->(type),
(40)-[:af909713-68f5-4b6d-89d5-03f7fc7fd5c1_geom]->(hasGeometry),
(40)-[:nan]->(comment),
(40)-[:Kastell Sămbotin (Castra Traiana)]->(label),
(43)-[:Point]->(type),
(43)-[:4326> POINT (24.592319 47.096014)]->(asWKT),
(43)-[:Kastell Orheiul Bistriţei Geometry]->(label),
(46)-[:Point]->(type),
(46)-[:4326> POINT (24.400833 44.166667)]->(asWKT),
(46)-[:Malva) Geometry]->(label),
(49)-[:Point]->(type),
(49)-[:4326> POINT (25.441581 45.618708)]->(asWKT),
(49)-[:Kastell Râșnov Geometry]->(label),
(52)-[:Point]->(type),
(52)-[:4326> POINT (24.272806 45.523639)]->(asWKT),
(52)-[:Kastell Râul Vadului Geometry]->(label),
(55)-[:MilitaryCamp]->(type),
(55)-[:86dae60a-c827-480d-bb38-04a480b9ea01_geom]->(hasGeometry),
(55)-[:Kohortenkastell (?)]->(comment),
(55)-[:Kastell Cenad]->(label),
(58)-[:Point]->(type),
(58)-[:4326> POINT (21.232794 44.897786)]->(asWKT),
(58)-[:Kastell Grebenac Geometry]->(label),
(61)-[:MilitaryCamp]->(type),
(61)-[:1e218e82-f264-4241-a8e0-5efd9a1ec8a4_geom]->(hasGeometry),
(61)-[:nan]->(comment),
(61)-[:Kastell Islaz-Razovica]->(label),
(64)-[:MilitaryCamp]->(type),
(64)-[:80ce787b-1ab0-42e7-b03c-c641d3767774_geom]->(hasGeometry),
(64)-[:nan]->(comment),
(64)-[:Kastell Perisani]->(label),
(67)-[:MilitaryCamp]->(type),
(67)-[:1c936059-6af8-4f03-8e18-cc61f529c5f3_geom]->(hasGeometry),
(67)-[:Auxiliarkastelle]->(comment),
(67)-[:Kastelle von Porolissum]->(label),
(71)-[:Point]->(type),
(71)-[:4326> POINT (25.849619 45.970939)]->(asWKT),
(71)-[:Kastell Olteni Geometry]->(label),
(74)-[:Point]->(type),
(74)-[:4326> POINT (22.814906 45.914594)]->(asWKT),
(74)-[:Kastell Vețel Geometry]->(label),
(77)-[:MilitaryCamp]->(type),
(77)-[:b5cf0c45-ec51-4710-a03a-75e7dc30a7a3_geom]->(hasGeometry),
(77)-[:Kohortenkastell]->(comment),
(77)-[:Kastell Romanasi (Largiana)]->(label),
(81)-[:Point]->(type),
(81)-[:4326> POINT (25.012694 45.221)]->(asWKT),
(81)-[:Kastell Câmpulung Muscel II Geometry]->(label),
(84)-[:Point]->(type),
(84)-[:4326> POINT (24.8375 44.771389)]->(asWKT),
(84)-[:Kastell Albota Geometry]->(label),
(87)-[:Point]->(type),
(87)-[:4326> POINT (23.37 45.18)]->(asWKT),
(87)-[:Kastell Plesa Geometry]->(label),
(90)-[:MilitaryCamp]->(type),
(90)-[:6689fc0e-01ff-4dbc-b3ed-49e35a3d397a_geom]->(hasGeometry),
(90)-[:nan]->(comment),
(90)-[:Kastell Bologa (Resculum)]->(label),
(92)-[:Point]->(type),
(92)-[:4326> POINT (24.8945 44.958083)]->(asWKT),
(92)-[:Kastell Purcăreni Geometry]->(label),
(95)-[:MilitaryCamp]->(type),
(95)-[:e2573931-d743-40c3-a6b7-08ffeb244daa_geom]->(hasGeometry),
(95)-[:nan]->(comment),
(95)-[:Kastell Valea Urluii]->(label),
(98)-[:Point]->(type),
(98)-[:4326> POINT (24.308611 45.495)]->(asWKT),
(98)-[:Kastell Căineni (Pons Vetus ?) Geometry]->(label),
(102)-[:Point]->(type),
(102)-[:4326> POINT (21.629394 45.426539)]->(asWKT),
(102)-[:Kastell Berzovia Geometry]->(label),
(106)-[:Point]->(type),
(106)-[:4326> POINT (25.591561 45.816419)]->(asWKT),
(106)-[:Kastell Feldioara Geometry]->(label),
(109)-[:MilitaryCamp]->(type),
(109)-[:9ba7d74c-175e-48c8-9403-dbbdd650ed22_geom]->(hasGeometry),
(109)-[:nan]->(comment),
(109)-[:Kastell Cristeşti]->(label),
(112)-[:Point]->(type),
(112)-[:4326> POINT (23.327689 47.227733)]->(asWKT),
(112)-[:Kastell Tihău Geometry]->(label),
(115)-[:MilitaryCamp]->(type),
(115)-[:bf339c52-9ac1-4b87-94ab-2dc33bc7d3e4_geom]->(hasGeometry),
(115)-[:nan]->(comment),
(115)-[:Kastell Odorheiul Secuiesc]->(label),
(118)-[:Point]->(type),
(118)-[:4326> POINT (24.761056 44.307778)]->(asWKT),
(118)-[:Kastell Ghioca Geometry]->(label),
(121)-[:Point]->(type),
(121)-[:4326> POINT (23.164364 45.897053)]->(asWKT),
(121)-[:Kastell Cigmău Geometry]->(label),
(124)-[:MilitaryCamp]->(type),
(124)-[:ec646e12-636f-4c8c-96c2-0f46833adf1c_geom]->(hasGeometry),
(124)-[:Auxiliarkastell]->(comment),
(124)-[:Kastell Răcarii de Jos]->(label),
(128)-[:MilitaryCamp]->(type),
(128)-[:cba75304-f136-465d-90fb-56dff3acc018_geom]->(hasGeometry),
(128)-[:nan]->(comment),
(128)-[:Kastell Enoşeşti (Acidava)]->(label),
(131)-[:Point]->(type),
(131)-[:4326> POINT (23.92 43.834167)]->(asWKT),
(131)-[:Kastell Lişteava Geometry]->(label),
(134)-[:MilitaryCamp]->(type),
(134)-[:322e89c0-f571-4be4-a08c-84b35efb69e5_geom]->(hasGeometry),
(134)-[:nan]->(comment),
(134)-[:Kastell Sânpaul]->(label),
(137)-[:Point]->(type),
(137)-[:4326> POINT (24.266011 45.635769)]->(asWKT),
(137)-[:Kastell Boiţa (Caput Stenarum) Geometry]->(label),
(140)-[:Point]->(type),
(140)-[:4326> POINT (22.4076 44.7382)]->(asWKT),
(140)-[:Kastell Orșova (Dierna) Geometry]->(label),
(143)-[:Point]->(type),
(143)-[:4326> POINT (24.30325 44.374806)]->(asWKT),
(143)-[:Kastell Enoşeşti (Acidava) Geometry]->(label),
(146)-[:Point]->(type),
(146)-[:4326> POINT (24.762111 44.484583)]->(asWKT),
(146)-[:Kastell Urluieni II Geometry]->(label),
(149)-[:MilitaryCamp]->(type),
(149)-[:096a9a4c-020f-4ce0-a4a6-993d50d08fea_geom]->(hasGeometry),
(149)-[:nan]->(comment),
(149)-[:Kastell Copăceni (Praetorium I)]->(label),
(152)-[:Point]->(type),
(152)-[:4326> POINT (25.3002 46.3131)]->(asWKT),
(152)-[:Kastell Odorheiul Secuiesc Geometry]->(label),
(155)-[:Point]->(type),
(155)-[:4326> POINT (23.571847 44.514)]->(asWKT),
(155)-[:Kastell Răcarii de Jos Geometry]->(label),
(158)-[:Point]->(type),
(158)-[:4326> POINT (24.983333 43.7345)]->(asWKT),
(158)-[:Kastell Flămănda (Poiana) Geometry]->(label),
(161)-[:Point]->(type),
(161)-[:4326> POINT (24.27 44.650306)]->(asWKT),
(161)-[:Kastell Momoteşti (Rusidava) Geometry]->(label),
(164)-[:Point]->(type),
(164)-[:4326> POINT (24.947028 44.074472)]->(asWKT),
(164)-[:Kastell Roșiorii de Vede Geometry]->(label),
(167)-[:Point]->(type),
(167)-[:4326> POINT (24.96525 43.937806)]->(asWKT),
(167)-[:Kastell Băneasa I Geometry]->(label),
(170)-[:Point]->(type),
(170)-[:4326> POINT (21.847883 45.486656)]->(asWKT),
(170)-[:Kastell Aizis Geometry]->(label),
(173)-[:MilitaryCamp]->(type),
(173)-[:ed79872f-dcb1-48d0-a008-5a3c65432a67_geom]->(hasGeometry),
(173)-[:Kohortenkastell (?)]->(comment),
(173)-[:Kastell Aradul Nou]->(label),
(176)-[:Point]->(type),
(176)-[:4326> POINT (24.785111 44.603278)]->(asWKT),
(176)-[:Kastell Fâlfani Geometry]->(label),
(179)-[:MilitaryCamp]->(type),
(179)-[:918ef494-4408-4a91-8ee0-61f6087ffee7_geom]->(hasGeometry),
(179)-[:nan]->(comment),
(179)-[:Kastell Surducul Mare]->(label),
(182)-[:MilitaryCamp]->(type),
(182)-[:8fa245f8-ffe5-4e74-b259-410c7be91afd_geom]->(hasGeometry),
(182)-[:nan]->(comment),
(182)-[:Kastell Titeşti]->(label),
(185)-[:Point]->(type),
(185)-[:4326> POINT (23.571889 44.514111)]->(asWKT),
(185)-[:Kastell Mofleni (Pelendava) Geometry]->(label),
(188)-[:Point]->(type),
(188)-[:4326> POINT (23.772733 46.570536)]->(asWKT),
(188)-[:Legionslager Potaissa Geometry]->(label),
(191)-[:Point]->(type),
(191)-[:4326> POINT (23.157319 47.179167)]->(asWKT),
(191)-[:Kastelle von Porolissum Geometry]->(label),
(194)-[:MilitaryCamp]->(type),
(194)-[:f8305d66-9429-43c0-b6e3-73721df9986b_geom]->(hasGeometry),
(194)-[:nan]->(comment),
(194)-[:Kastell Urluieni II]->(label),
(196)-[:MilitaryCamp]->(type),
(196)-[:3680e065-f377-4f4d-a9d6-84523dcb1727_geom]->(hasGeometry),
(196)-[:Kohortenkastell]->(comment),
(196)-[:Kastell Brețcu ]->(label),
(199)-[:MilitaryCamp]->(type),
(199)-[:340738ca-7444-4896-a0fd-cd9e6806eb30_geom]->(hasGeometry),
(199)-[:nan]->(comment),
(199)-[:Kastell Mehadia (Praetorium)]->(label),
(202)-[:Point]->(type),
(202)-[:4326> POINT (21.300194 45.122669)]->(asWKT),
(202)-[:Kastell Vršac Geometry]->(label),
(205)-[:MilitaryCamp]->(type),
(205)-[:3f7e0b8c-1a5f-423f-85da-536d87bbdcc8_geom]->(hasGeometry),
(205)-[:nan]->(comment),
(205)-[:Kastell Orheiul Bistriţei]->(label),
(207)-[:MilitaryCamp]->(type),
(207)-[:d2adbbd5-f4a7-471d-a817-b28e37bcbfb1_geom]->(hasGeometry),
(207)-[: Alenkastell]->(comment),
(207)-[:Kastell Banatska Palanka]->(label),
(211)-[:Point]->(type),
(211)-[:4326> POINT (21.587219 45.265)]->(asWKT),
(211)-[:Kastell Surducul Mare Geometry]->(label),
(214)-[:Point]->(type),
(214)-[:4326> POINT (25.300011 45.983367)]->(asWKT),
(214)-[:Kastell Hoghiz Geometry]->(label),
(217)-[:Point]->(type),
(217)-[:4326> POINT (24.016667 44.116667)]->(asWKT),
(217)-[:Kastell Castranova Geometry]->(label),
(220)-[:MilitaryCamp]->(type),
(220)-[:1795d125-e071-4153-b07e-e147bb19ad65_geom]->(hasGeometry),
(220)-[:nan]->(comment),
(220)-[:Kastell Comalău]->(label),
(223)-[:Point]->(type),
(223)-[:4326> POINT (23.172444 47.106944)]->(asWKT),
(223)-[:Kastell Romita Geometry]->(label),
(226)-[:MilitaryCamp]->(type),
(226)-[:4198c975-e14a-4fb3-9b2e-7be9e145ecac_geom]->(hasGeometry),
(226)-[:nan]->(comment),
(226)-[:Kastell Jiblea]->(label),
(229)-[:MilitaryCamp]->(type),
(229)-[:7cadca30-bfd9-4628-9916-c20eecafa356_geom]->(hasGeometry),
(229)-[:Kohortenkastell]->(comment),
(229)-[:Kastell Stolniceni]->(label),
(232)-[:MilitaryCamp]->(type),
(232)-[:7aa137c0-3763-4bd3-a1ec-bd8a88b3d786_geom]->(hasGeometry),
(232)-[:Kohortenkastell]->(comment),
(232)-[:Kastell Călugăreni]->(label),
(235)-[:MilitaryCamp]->(type),
(235)-[:0f25c729-a3c7-4cb4-b063-ff72c0124b4f_geom]->(hasGeometry),
(235)-[:nan]->(comment),
(235)-[:Kastell Urluieni I]->(label),
(238)-[:MilitaryCamp]->(type),
(238)-[:6c5d4f2f-8a7b-4ad5-8672-f4ecc7e80ff0_geom]->(hasGeometry),
(238)-[:nan]->(comment),
(238)-[:Kastell Băneasa I]->(label),
(240)-[:MilitaryCamp]->(type),
(240)-[:c8ecf3da-c535-41df-b06e-298cd8542633_geom]->(hasGeometry),
(240)-[:nan]->(comment),
(240)-[:Kastell Teregova (Ad Pannonios)]->(label),
(243)-[:MilitaryCamp]->(type),
(243)-[:c3a471a8-ab67-4e9c-b127-1eff017b0cb4_geom]->(hasGeometry),
(243)-[:nan]->(comment),
(243)-[:Kastell Albota]->(label),
(245)-[:MilitaryCamp]->(type),
(245)-[:d92ef45f-91c4-442e-b279-61f17fbccb7c_geom]->(hasGeometry),
(245)-[:nan]->(comment),
(245)-[:Kastell Ilişua (Arcobara)]->(label),
(248)-[:MilitaryCamp]->(type),
(248)-[:815f5c63-8478-4aac-bafb-11eaafa9a923_geom]->(hasGeometry),
(248)-[:Auxiliarkastell]->(comment),
(248)-[:Kastell Dupljaja]->(label),
(251)-[:MilitaryCamp]->(type),
(251)-[:42d9c007-47e1-4b2a-ab2c-c381f93cac96_geom]->(hasGeometry),
(251)-[:Auxiliarkastell]->(comment),
(251)-[:Kastell Grebenac]->(label),
(253)-[:MilitaryCamp]->(type),
(253)-[:9a084d40-bf5c-42fa-8aa7-8c678524c631_geom]->(hasGeometry),
(253)-[:nan]->(comment),
(253)-[:Kastell Racoviţa (Praetorium II)]->(label),
(256)-[:MilitaryCamp]->(type),
(256)-[:5e33b468-4135-46b4-babc-99f5c423f966_geom]->(hasGeometry),
(256)-[:Kohortenkastell (?)]->(comment),
(256)-[:Kastell Szeged]->(label),
(259)-[:MilitaryCamp]->(type),
(259)-[:bd14e9f3-dd38-4329-a655-60b00fd8d5b7_geom]->(hasGeometry),
(259)-[:nan]->(comment),
(259)-[:Kastell Sighisoara]->(label),
(261)-[:Point]->(type),
(261)-[:4326> POINT (24.360675 45.105944)]->(asWKT),
(261)-[:Kastell Stolniceni Geometry]->(label),
(264)-[:MilitaryCamp]->(type),
(264)-[:47a7d25e-6315-4256-b257-c2dfaea5e42f_geom]->(hasGeometry),
(264)-[:nan]->(comment),
(264)-[:Kastell Zăvoi (Acmonia ?)]->(label),
(267)-[:Point]->(type),
(267)-[:4326> POINT (22.786822 45.51665)]->(asWKT),
(267)-[:Kastell Sarmizegetusa (Ulpia Traiana) Geometry]->(label),
(270)-[:MilitaryCamp]->(type),
(270)-[:70d51242-571e-43ce-bd01-3bffca8cb4be_geom]->(hasGeometry),
(270)-[:Kohortenkastell]->(comment),
(270)-[:Kastell Feldioara]->(label),
(272)-[:Point]->(type),
(272)-[:4326> POINT (24.360556 45.231944)]->(asWKT),
(272)-[:Kastell Jiblea Geometry]->(label),
(275)-[:MilitaryCamp]->(type),
(275)-[:5b90b8d5-ba6e-4789-94d2-db823824acbf_geom]->(hasGeometry),
(275)-[:nan]->(comment),
(275)-[:Kastell Căineni (Pons Vetus ?)]->(label),
(277)-[:Point]->(type),
(277)-[:4326> POINT (24.528969 44.081789)]->(asWKT),
(277)-[:Kastell Slăveni Geometry]->(label),
(280)-[:MilitaryCamp]->(type),
(280)-[:1d8f65a8-c30b-40f1-9676-2e1145691ac3_geom]->(hasGeometry),
(280)-[:nan]->(comment),
(280)-[:Kastell Abrud (Alburnus Maior)]->(label),
(283)-[:MilitaryCamp]->(type),
(283)-[:707cb61a-d04e-4c7b-a620-6587db82f116_geom]->(hasGeometry),
(283)-[:nan]->(comment),
(283)-[:Kastell Purcăreni]->(label),
(285)-[:MilitaryCamp]->(type),
(285)-[:4e013c45-7445-4ea6-8356-2c9cc9e7ac6e_geom]->(hasGeometry),
(285)-[:Auxiliarkastell]->(comment),
(285)-[:Kastell Gilău]->(label),
(288)-[:MilitaryCamp]->(type),
(288)-[:8f823c04-d42b-49ec-879d-2c446d575885_geom]->(hasGeometry),
(288)-[:nan]->(comment),
(288)-[:Kastell Voineşti]->(label),
(291)-[:Point]->(type),
(291)-[:4326> POINT (22.306831 45.168611)]->(asWKT),
(291)-[:Kastell Teregova (Ad Pannonios) Geometry]->(label),
(294)-[:LegionaryCamp]->(type),
(294)-[:ffd99607-0513-4fa5-8073-c80bddbfab84_geom]->(hasGeometry),
(294)-[:Legionslager]->(comment),
(294)-[:Kastell Tibiscum]->(label),
(297)-[:Point]->(type),
(297)-[:4326> POINT (23.837639 47.186222)]->(asWKT),
(297)-[:Kastell Căşeiu (Samum) Geometry]->(label),
(300)-[:MilitaryCamp]->(type),
(300)-[:120e3991-1f39-4359-b810-37bb24aff05c_geom]->(hasGeometry),
(300)-[:Kohortenkastell]->(comment),
(300)-[:Kastell Romita]->(label),
(302)-[:Point]->(type),
(302)-[:4326> POINT (23.166667 45.733333)]->(asWKT),
(302)-[:Kastell Orăştioara de Sus Geometry]->(label),
(305)-[:Point]->(type),
(305)-[:4326> POINT (23.4 45.166667)]->(asWKT),
(305)-[:Kastell Bumbeşti Geometry]->(label),
(308)-[:MilitaryCamp]->(type),
(308)-[:7422f9df-da23-450f-8eac-db2d8dfca42e_geom]->(hasGeometry),
(308)-[:nan]->(comment),
(308)-[:Kastell Livezile]->(label),
(310)-[:MilitaryCamp]->(type),
(310)-[:f81e10af-8e41-447d-b601-dcba5311199b_geom]->(hasGeometry),
(310)-[:nan]->(comment),
(310)-[:Malva)]->(label),
(312)-[:Point]->(type),
(312)-[:4326> POINT (22.924444 44.838889)]->(asWKT),
(312)-[:Kastell Cătunele Geometry]->(label),
(316)-[:Point]->(type),
(316)-[:4326> POINT (22.3522 44.9229)]->(asWKT),
(316)-[:Kastell Mehadia (Praetorium) Geometry]->(label),
(319)-[:MilitaryCamp]->(type),
(319)-[:0203af0b-bc52-4f9f-b490-b2bc3fe431fc_geom]->(hasGeometry),
(319)-[:Auxiliarkastell]->(comment),
(319)-[:Kastell Cigmău ]->(label),
(321)-[:MilitaryCamp]->(type),
(321)-[:7b05b48b-cd48-4c66-916e-6ea581179843_geom]->(hasGeometry),
(321)-[:nan]->(comment),
(321)-[:Kastell Islaz-Verdea]->(label),
(325)-[:MilitaryCamp]->(type),
(325)-[:f35f2d3f-8925-4139-9e9b-cf07ee5aaecb_geom]->(hasGeometry),
(325)-[:nan]->(comment),
(325)-[:Kastell Borosneu Mare]->(label),
(328)-[:Point]->(type),
(328)-[:4326> POINT (24.476111 46.510556)]->(asWKT),
(328)-[:Kastell Cristeşti Geometry]->(label),
(331)-[:Point]->(type),
(331)-[:4326> POINT (25.900222 45.844172)]->(asWKT),
(331)-[:Kastell Comalău Geometry]->(label),
(334)-[:MilitaryCamp]->(type),
(334)-[:9a118e00-be2c-4c2d-a9f9-8cb86170e3d1_geom]->(hasGeometry),
(334)-[:nan]->(comment),
(334)-[:Kastell Rădăcineşti]->(label),
(337)-[:LegionaryCamp]->(type),
(337)-[:fddcce1d-ea5f-4dc2-a2d1-740ca41fa97e_geom]->(hasGeometry),
(337)-[:Legionslager]->(comment),
(337)-[:Legionslager Alba Julia]->(label),
(340)-[:Point]->(type),
(340)-[:4326> POINT (26.016986 45.843861)]->(asWKT),
(340)-[:Kastell Borosneu Mare Geometry]->(label),
(343)-[:Point]->(type),
(343)-[:4326> POINT (22.1895 45.4663)]->(asWKT),
(343)-[:Kastell Tibiscum Geometry]->(label),
(346)-[:MilitaryCamp]->(type),
(346)-[:4df4edbc-facd-42bd-b05e-076f94ae693b_geom]->(hasGeometry),
(346)-[:nan]->(comment),
(346)-[:Kastell IIoneștii Govorii (Pons Aluti)]->(label),
(349)-[:MilitaryCamp]->(type),
(349)-[:5a43030f-b985-4444-8cf9-3e4a0b132d79_geom]->(hasGeometry),
(349)-[:nan]->(comment),
(349)-[:Kastell Vârtop]->(label),
(352)-[:Point]->(type),
(352)-[:4326> POINT (24.757222 43.733056)]->(asWKT),
(352)-[:Kastell Racoviţa (Praetorium II) Geometry]->(label),
(355)-[:Point]->(type),
(355)-[:4326> POINT (23.372222 45.1825)]->(asWKT),
(355)-[:Kastell Vârtop Geometry]->(label),
(358)-[:MilitaryCamp]->(type),
(358)-[:b0524f84-a9d2-45fa-9f69-d8164ad73440_geom]->(hasGeometry),
(358)-[:Kohortenkastell]->(comment),
(358)-[:Kastell Olteni]->(label),
(360)-[:MilitaryCamp]->(type),
(360)-[:50320dbe-929c-40e3-aebd-f8f257d6472a_geom]->(hasGeometry),
(360)-[:nan]->(comment),
(360)-[:Kastell Castranova]->(label),
(362)-[:MilitaryCamp]->(type),
(362)-[:19360a61-a15a-4d56-a100-f3be57e93ff1_geom]->(hasGeometry),
(362)-[:nan]->(comment),
(362)-[:Kastell Mofleni (Pelendava)]->(label),
(364)-[:Point]->(type),
(364)-[:4326> POINT (23.068611 46.272222)]->(asWKT),
(364)-[:Kastell Abrud (Alburnus Maior) Geometry]->(label),
(367)-[:MilitaryCamp]->(type),
(367)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2_geom]->(hasGeometry),
(367)-[:nan]->(comment),
(367)-[:Kastell Câmpulung Muscel II]->(label),
(369)-[:GeometryCollection]->(type),
(369)-[:aadec8db-70f9-4c40-833a-2a7c39c631d2_geom]->(member),
(369)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2_geom]->(member),
(369)-[:b6e369cd-722a-4a1c-a984-538bb26f3777_geom]->(member),
(369)-[:c3a471a8-ab67-4e9c-b127-1eff017b0cb4_geom]->(member),
(369)-[:cba75304-f136-465d-90fb-56dff3acc018_geom]->(member),
(369)-[:d2adbbd5-f4a7-471d-a817-b28e37bcbfb1_geom]->(member),
(369)-[:d92ef45f-91c4-442e-b279-61f17fbccb7c_geom]->(member),
(369)-[:e0423dfe-4fdf-4bf6-8453-97d7bee4d031_geom]->(member),
(369)-[:e3899f66-1234-4a44-b16e-2ead1e0bf696_geom]->(member),
(369)-[:e69e6cb2-cded-446c-b159-daec78476f43_geom]->(member),
(369)-[:e811fe5a-92d2-43a0-a572-51bc5942e242_geom]->(member),
(369)-[:ed79872f-dcb1-48d0-a008-5a3c65432a67_geom]->(member),
(369)-[:f35f2d3f-8925-4139-9e9b-cf07ee5aaecb_geom]->(member),
(369)-[:0ab5e10e-4fb0-4854-835b-389043840ee0_geom]->(member),
(369)-[:0fe1d8dd-b425-4d55-ae80-2cd8d5d61ace_geom]->(member),
(369)-[:0203af0b-bc52-4f9f-b490-b2bc3fe431fc_geom]->(member),
(369)-[:096a9a4c-020f-4ce0-a4a6-993d50d08fea_geom]->(member),
(369)-[:1d8f65a8-c30b-40f1-9676-2e1145691ac3_geom]->(member),
(369)-[:1e218e82-f264-4241-a8e0-5efd9a1ec8a4_geom]->(member),
(369)-[:1795d125-e071-4153-b07e-e147bb19ad65_geom]->(member),
(369)-[:3af3a2c4-8038-482d-9fa9-a0e90584ef6d_geom]->(member),
(369)-[:3b51185a-d7ca-4c22-b85d-a021b3727c4d_geom]->(member),
(369)-[:34d0d768-2d4d-42b3-82ae-e29bad5c1eed_geom]->(member),
(369)-[:3680e065-f377-4f4d-a9d6-84523dcb1727_geom]->(member),
(369)-[:4dbfae9e-f0f7-4dab-94ca-9bca2cec83aa_geom]->(member),
(369)-[:4df4edbc-facd-42bd-b05e-076f94ae693b_geom]->(member),
(369)-[:4e013c45-7445-4ea6-8356-2c9cc9e7ac6e_geom]->(member),
(369)-[:4198c975-e14a-4fb3-9b2e-7be9e145ecac_geom]->(member),
(369)-[:5b90b8d5-ba6e-4789-94d2-db823824acbf_geom]->(member),
(369)-[:5d0fac8e-53ae-4ae7-92a2-dd419eee0dce_geom]->(member),
(369)-[:5e6a65c9-32dd-4581-b6ab-a95afdc4d061_geom]->(member),
(369)-[:5ea0f057-026f-4556-97f5-3e0e3a9471c3_geom]->(member),
(369)-[:50320dbe-929c-40e3-aebd-f8f257d6472a_geom]->(member),
(369)-[:6c5d4f2f-8a7b-4ad5-8672-f4ecc7e80ff0_geom]->(member),
(369)-[:64ae9ea8-9dca-4e22-b32b-c2f95fd80b44_geom]->(member),
(369)-[:6689fc0e-01ff-4dbc-b3ed-49e35a3d397a_geom]->(member),
(369)-[:7aa137c0-3763-4bd3-a1ec-bd8a88b3d786_geom]->(member),
(369)-[:7b05b48b-cd48-4c66-916e-6ea581179843_geom]->(member),
(369)-[:7c3bf06c-8f79-457e-b56f-77da98c7a69b_geom]->(member),
(369)-[:7cb289bf-4a31-467d-9c9d-4271a8dc55c9_geom]->(member),
(369)-[:7e6b0abd-392e-48da-a973-52db57e43459_geom]->(member),
(369)-[:70d51242-571e-43ce-bd01-3bffca8cb4be_geom]->(member),
(369)-[:7422f9df-da23-450f-8eac-db2d8dfca42e_geom]->(member),
(369)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2_geom]->(member),
(369)-[:815f5c63-8478-4aac-bafb-11eaafa9a923_geom]->(member),
(369)-[:86dae60a-c827-480d-bb38-04a480b9ea01_geom]->(member),
(369)-[:9ac48ee9-00b6-46ab-a597-b6aa5f2d784a_geom]->(member),
(369)-[:9b62118c-9936-42f2-a6e7-49f649c937f2_geom]->(member),
(369)-[:9ba7d74c-175e-48c8-9403-dbbdd650ed22_geom]->(member),
(369)-[:Limes Daicus Geometries]->(label),
(382)-[:LegionaryCamp]->(type),
(382)-[:87009579-c2cc-4c7a-9b02-901bf75a0ee6_geom]->(hasGeometry),
(382)-[:Legionslager]->(comment),
(382)-[:Kastell Vețel]->(label),
(384)-[:MilitaryCamp]->(type),
(384)-[:986efe66-cf8a-4b64-a488-ad95d0f2dd79_geom]->(hasGeometry),
(384)-[:Kohortenkastell]->(comment),
(384)-[:Kastell Tihău]->(label),
(386)-[:Point]->(type),
(386)-[:4326> POINT (23.044569 47.048264)]->(asWKT),
(386)-[:Kastell Buciumi Geometry]->(label),
(389)-[:Point]->(type),
(389)-[:4326> POINT (24.312389 45.309667)]->(asWKT),
(389)-[:Kastell Bivolari (Arutela) Geometry]->(label),
(392)-[:Point]->(type),
(392)-[:4326> POINT (24.866611 45.842519)]->(asWKT),
(392)-[:Kastell Cincsor Geometry]->(label),
(395)-[:Point]->(type),
(395)-[:4326> POINT (23.181678 47.113403)]->(asWKT),
(395)-[:Kastell Romanasi (Largiana) Geometry]->(label),
(398)-[:MilitaryCamp]->(type),
(398)-[:2c2fb600-f249-469e-a025-1961edf5132d_geom]->(hasGeometry),
(398)-[:nan]->(comment),
(398)-[:Kastell Războieni]->(label),
(401)-[:MilitaryCamp]->(type),
(401)-[:9f76d5fd-4ee3-4985-9fb6-c22bfdf43436_geom]->(hasGeometry),
(401)-[:nan]->(comment),
(401)-[:Kastell Putineiu]->(label),
(404)-[:Point]->(type),
(404)-[:4326> POINT (24.394444 45.409722)]->(asWKT),
(404)-[:Kastell Titeşti Geometry]->(label),
(407)-[:Point]->(type),
(407)-[:4326> POINT (23.251667 46.986086)]->(asWKT),
(407)-[:Kastell Sutoru Geometry]->(label),
(410)-[:Point]->(type),
(410)-[:4326> POINT (24.961889 43.935889)]->(asWKT),
(410)-[:Kastell Băneasa II Geometry]->(label),
(413)-[:Point]->(type),
(413)-[:4326> POINT (24.762222 43.710278)]->(asWKT),
(413)-[:Kastell Islaz-Verdea Geometry]->(label),
(416)-[:Point]->(type),
(416)-[:4326> POINT (24.236111 44.883333)]->(asWKT),
(416)-[:Kastell IIoneștii Govorii (Pons Aluti) Geometry]->(label),
(419)-[:Point]->(type),
(419)-[:4326> POINT (25.008889 46.562222)]->(asWKT),
(419)-[:Kastell Sarateni Geometry]->(label),
(422)-[:Point]->(type),
(422)-[:4326> POINT (24.400833 45.370833)]->(asWKT),
(422)-[:Kastell Perisani Geometry]->(label),
(425)-[:Point]->(type),
(425)-[:4326> POINT (23.868333 46.417222)]->(asWKT),
(425)-[:Kastell Războieni Geometry]->(label),
(428)-[:MilitaryCamp]->(type),
(428)-[:0ab5e10e-4fb0-4854-835b-389043840ee0_geom]->(hasGeometry),
(428)-[:nan]->(comment),
(428)-[:Kastell Lişteava]->(label),
(430)-[:MilitaryCamp]->(type),
(430)-[:10b043a5-bb2b-48af-a168-84046185d6f7_geom]->(hasGeometry),
(430)-[:nan]->(comment),
(430)-[:Kastell Pinoasa]->(label),
(433)-[:MilitaryCamp]->(type),
(433)-[:a6ec226a-3c2a-444a-9221-839201e1135f_geom]->(hasGeometry),
(433)-[:nan]->(comment),
(433)-[:Kastell Săpata de Jos I]->(label),
(436)-[:Point]->(type),
(436)-[:4326> POINT (21.551161 45.079397)]->(asWKT),
(436)-[:Kastell Vărădia Geometry]->(label),
(439)-[:Point]->(type),
(439)-[:4326> POINT (21.275078 44.927103)]->(asWKT),
(439)-[:Kastell Dupljaja Geometry]->(label),
(442)-[:Point]->(type),
(442)-[:4326> POINT (24.763556 44.707333)]->(asWKT),
(442)-[:Kastell Săpata de Jos I Geometry]->(label),
(445)-[:MilitaryCamp]->(type),
(445)-[:0ccd99fd-62d1-4978-873a-106b1f5e3880_geom]->(hasGeometry),
(445)-[:nan]->(comment),
(445)-[:Kastell Rucăr]->(label),
(448)-[:MilitaryCamp]->(type),
(448)-[:9b62118c-9936-42f2-a6e7-49f649c937f2_geom]->(hasGeometry),
(448)-[:nan]->(comment),
(448)-[:Kastell Bumbeşti]->(label),
(450)-[:Point]->(type),
(450)-[:4326> POINT (25.012472 45.22075)]->(asWKT),
(450)-[:Kastell Câmpulung Muscel I Geometry]->(label),
(453)-[:MilitaryCamp]->(type),
(453)-[:f42bb013-afeb-4044-9886-ece53cc813d4_geom]->(hasGeometry),
(453)-[:Auxiliarkastell]->(comment),
(453)-[:Kastell Sutoru]->(label),
(455)-[:MilitaryCamp]->(type),
(455)-[:06eb8de4-750e-4ed9-ad04-9bf16d61c975_geom]->(hasGeometry),
(455)-[:nan]->(comment),
(455)-[:Kastell Momoteşti (Rusidava)]->(label),
(457)-[:MilitaryCamp]->(type),
(457)-[:01189de6-024d-4022-96ff-eec7e4efee0c_geom]->(hasGeometry),
(457)-[:nan]->(comment),
(457)-[:Kastell Orșova (Dierna)]->(label),
(459)-[:MilitaryCamp]->(type),
(459)-[:5e6a65c9-32dd-4581-b6ab-a95afdc4d061_geom]->(hasGeometry),
(459)-[:nan]->(comment),
(459)-[:Kastell Câmpulung Muscel I]->(label),
(461)-[:MilitaryCamp]->(type),
(461)-[:7c3bf06c-8f79-457e-b56f-77da98c7a69b_geom]->(hasGeometry),
(461)-[:nan]->(comment),
(461)-[:Kastell Băneasa II]->(label),
(463)-[:Point]->(type),
(463)-[:4326> POINT (22.112283 46.006539)]->(asWKT),
(463)-[:Kastell Bulci Geometry]->(label),
(466)-[:Point]->(type),
(466)-[:4326> POINT (24.095361 47.210528)]->(asWKT),
(466)-[:Kastell Ilişua (Arcobara) Geometry]->(label),
(469)-[:Point]->(type),
(469)-[:4326> POINT (24.937389 44.061333)]->(asWKT),
(469)-[:Kastell Valea Urluii Geometry]->(label),
(472)-[:MilitaryCamp]->(type),
(472)-[:e811fe5a-92d2-43a0-a572-51bc5942e242_geom]->(hasGeometry),
(472)-[:nan]->(comment),
(472)-[:Kastell Aizis]->(label),
(474)-[:Point]->(type),
(474)-[:4326> POINT (22.410833 45.525278)]->(asWKT),
(474)-[:Kastell Zăvoi (Acmonia ?) Geometry]->(label),
(477)-[:Point]->(type),
(477)-[:4326> POINT (24.877311 46.628978)]->(asWKT),
(477)-[:Kastell Călugăreni Geometry]->(label),
(480)-[:MilitaryCamp]->(type),
(480)-[:4dbfae9e-f0f7-4dab-94ca-9bca2cec83aa_geom]->(hasGeometry),
(480)-[:nan]->(comment),
(480)-[:Kastell Flămănda (Poiana)]->(label),
(482)-[:MilitaryCamp]->(type),
(482)-[:7a5a0685-4a85-48f0-a5ac-7b3b56efa3dc_geom]->(hasGeometry),
(482)-[:nan]->(comment),
(482)-[:Kastell Roșiorii de Vede]->(label),
(484)-[:Point]->(type),
(484)-[:4326> POINT (24.441944 45.281528)]->(asWKT),
(484)-[:Kastell Rădăcineşti Geometry]->(label),
(487)-[:MilitaryCamp]->(type),
(487)-[:e0423dfe-4fdf-4bf6-8453-97d7bee4d031_geom]->(hasGeometry),
(487)-[:nan]->(comment),
(487)-[:Kastell Ghioca]->(label),
(489)-[:MilitaryCamp]->(type),
(489)-[:64ae9ea8-9dca-4e22-b32b-c2f95fd80b44_geom]->(hasGeometry),
(489)-[:nan]->(comment),
(489)-[:Kastell Fâlfani]->(label),
(491)-[:Point]->(type),
(491)-[:4326> POINT (23.572314 46.066694)]->(asWKT),
(491)-[:Legionslager Alba Julia Geometry]->(label),
(494)-[:Point]->(type),
(494)-[:4326> POINT (20.585819 46.138106)]->(asWKT),
(494)-[:Kastell Cenad Geometry]->(label),
(497)-[:Point]->(type),
(497)-[:4326> POINT (23.391764 46.754058)]->(asWKT),
(497)-[:Kastell Gilău Geometry]->(label),
(500)-[:Point]->(type),
(500)-[:4326> POINT (24.766042 46.861514)]->(asWKT),
(500)-[:Kastell Brâncoveneşti Geometry]->(label),
(503)-[:LegionaryCamp]->(type),
(503)-[:5709a2bb-8d86-44af-b582-19151b918068_geom]->(hasGeometry),
(503)-[:nan]->(comment),
(503)-[:Kastell Sarmizegetusa (Ulpia Traiana)]->(label),
(505)-[:MilitaryCamp]->(type),
(505)-[:3af3a2c4-8038-482d-9fa9-a0e90584ef6d_geom]->(hasGeometry),
(505)-[:Kohortenkastell (?)]->(comment),
(505)-[:Kastell Bulci]->(label),
(507)-[:Point]->(type),
(507)-[:4326> POINT (24.870833 43.751667)]->(asWKT),
(507)-[:Kastell Islaz-Razovica Geometry]->(label),
(510)-[:FeatureCollection]->(type),
(510)-[:aadec8db-70f9-4c40-833a-2a7c39c631d2]->(member),
(510)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2]->(member),
(510)-[:b6e369cd-722a-4a1c-a984-538bb26f3777]->(member),
(510)-[:c3a471a8-ab67-4e9c-b127-1eff017b0cb4]->(member),
(510)-[:cba75304-f136-465d-90fb-56dff3acc018]->(member),
(510)-[:d2adbbd5-f4a7-471d-a817-b28e37bcbfb1]->(member),
(510)-[:d92ef45f-91c4-442e-b279-61f17fbccb7c]->(member),
(510)-[:e0423dfe-4fdf-4bf6-8453-97d7bee4d031]->(member),
(510)-[:e3899f66-1234-4a44-b16e-2ead1e0bf696]->(member),
(510)-[:e69e6cb2-cded-446c-b159-daec78476f43]->(member),
(510)-[:e811fe5a-92d2-43a0-a572-51bc5942e242]->(member),
(510)-[:ed79872f-dcb1-48d0-a008-5a3c65432a67]->(member),
(510)-[:f35f2d3f-8925-4139-9e9b-cf07ee5aaecb]->(member),
(510)-[:0ab5e10e-4fb0-4854-835b-389043840ee0]->(member),
(510)-[:0fe1d8dd-b425-4d55-ae80-2cd8d5d61ace]->(member),
(510)-[:0203af0b-bc52-4f9f-b490-b2bc3fe431fc]->(member),
(510)-[:096a9a4c-020f-4ce0-a4a6-993d50d08fea]->(member),
(510)-[:1d8f65a8-c30b-40f1-9676-2e1145691ac3]->(member),
(510)-[:1e218e82-f264-4241-a8e0-5efd9a1ec8a4]->(member),
(510)-[:1795d125-e071-4153-b07e-e147bb19ad65]->(member),
(510)-[:3af3a2c4-8038-482d-9fa9-a0e90584ef6d]->(member),
(510)-[:3b51185a-d7ca-4c22-b85d-a021b3727c4d]->(member),
(510)-[:34d0d768-2d4d-42b3-82ae-e29bad5c1eed]->(member),
(510)-[:3680e065-f377-4f4d-a9d6-84523dcb1727]->(member),
(510)-[:4dbfae9e-f0f7-4dab-94ca-9bca2cec83aa]->(member),
(510)-[:4df4edbc-facd-42bd-b05e-076f94ae693b]->(member),
(510)-[:4e013c45-7445-4ea6-8356-2c9cc9e7ac6e]->(member),
(510)-[:4198c975-e14a-4fb3-9b2e-7be9e145ecac]->(member),
(510)-[:5b90b8d5-ba6e-4789-94d2-db823824acbf]->(member),
(510)-[:5d0fac8e-53ae-4ae7-92a2-dd419eee0dce]->(member),
(510)-[:5e6a65c9-32dd-4581-b6ab-a95afdc4d061]->(member),
(510)-[:5ea0f057-026f-4556-97f5-3e0e3a9471c3]->(member),
(510)-[:50320dbe-929c-40e3-aebd-f8f257d6472a]->(member),
(510)-[:6c5d4f2f-8a7b-4ad5-8672-f4ecc7e80ff0]->(member),
(510)-[:64ae9ea8-9dca-4e22-b32b-c2f95fd80b44]->(member),
(510)-[:6689fc0e-01ff-4dbc-b3ed-49e35a3d397a]->(member),
(510)-[:7aa137c0-3763-4bd3-a1ec-bd8a88b3d786]->(member),
(510)-[:7b05b48b-cd48-4c66-916e-6ea581179843]->(member),
(510)-[:7c3bf06c-8f79-457e-b56f-77da98c7a69b]->(member),
(510)-[:7cb289bf-4a31-467d-9c9d-4271a8dc55c9]->(member),
(510)-[:7e6b0abd-392e-48da-a973-52db57e43459]->(member),
(510)-[:70d51242-571e-43ce-bd01-3bffca8cb4be]->(member),
(510)-[:7422f9df-da23-450f-8eac-db2d8dfca42e]->(member),
(510)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2]->(member),
(510)-[:815f5c63-8478-4aac-bafb-11eaafa9a923]->(member),
(510)-[:86dae60a-c827-480d-bb38-04a480b9ea01]->(member),
(510)-[:9ac48ee9-00b6-46ab-a597-b6aa5f2d784a]->(member),
(510)-[:9b62118c-9936-42f2-a6e7-49f649c937f2]->(member),
(510)-[:9ba7d74c-175e-48c8-9403-dbbdd650ed22]->(member),
(510)-[:Limes Daicus Features]->(label),
(523)-[:Point]->(type),
(523)-[:4326> POINT (24.309861 45.395903)]->(asWKT),
(523)-[:Kastell Copăceni (Praetorium I) Geometry]->(label),
(526)-[:MilitaryCamp]->(type),
(526)-[:5d0fac8e-53ae-4ae7-92a2-dd419eee0dce_geom]->(hasGeometry),
(526)-[:Auxiliarkastell]->(comment),
(526)-[:Kastell Hoghiz]->(label),
(528)-[:MilitaryCamp]->(type),
(528)-[:b0cccdd1-2478-40bc-add2-a0e1bad88feb_geom]->(hasGeometry),
(528)-[:nan]->(comment),
(528)-[:Kastell Slăveni]->(label),
(530)-[:Point]->(type),
(530)-[:4326> POINT (24.965361 43.897806)]->(asWKT),
(530)-[:Kastell Putineiu Geometry]->(label),
(533)-[:MilitaryCamp]->(type),
(533)-[:5ea0f057-026f-4556-97f5-3e0e3a9471c3_geom]->(hasGeometry),
(533)-[:Alenkastell]->(comment),
(533)-[:Kastell Gherla]->(label),
(536)-[:MilitaryCamp]->(type),
(536)-[:0fe1d8dd-b425-4d55-ae80-2cd8d5d61ace_geom]->(hasGeometry),
(536)-[:nan]->(comment),
(536)-[:Kastell Căşeiu (Samum)]->(label),
(538)-[:MilitaryCamp]->(type),
(538)-[:aadec8db-70f9-4c40-833a-2a7c39c631d2_geom]->(hasGeometry),
(538)-[:nan]->(comment),
(538)-[:Kastell Cătunele]->(label),
(540)-[:MilitaryCamp]->(type),
(540)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2_geom]->(hasGeometry),
(540)-[:Kohortenkastell]->(comment),
(540)-[:Kastell Inlăceni]->(label),
(542)-[:MilitaryCamp]->(type),
(542)-[:e3899f66-1234-4a44-b16e-2ead1e0bf696_geom]->(hasGeometry),
(542)-[:nan]->(comment),
(542)-[:Kastell Cincsor]->(label),
(544)-[:Point]->(type),
(544)-[:4326> POINT (21.331111 44.845)]->(asWKT),
(544)-[:Kastell Banatska Palanka Geometry]->(label),
(547)-[:MilitaryCamp]->(type),
(547)-[:22bf9a4e-a715-43f7-9fd0-4a60b8b77288_geom]->(hasGeometry),
(547)-[:nan]->(comment),
(547)-[:Kastell Tia Mare]->(label),
(549)-[:Point]->(type),
(549)-[:4326> POINT (25.076083 45.297833)]->(asWKT),
(549)-[:Kastell Voineşti Geometry]->(label),
(552)-[:MilitaryCamp]->(type),
(552)-[:9d1c0c0d-98f5-4728-86ee-4288dde6d0fa_geom]->(hasGeometry),
(552)-[:Kohortenkastell]->(comment),
(552)-[:Kastell Râșnov ]->(label),
(554)-[:MilitaryCamp]->(type),
(554)-[:e69e6cb2-cded-446c-b159-daec78476f43_geom]->(hasGeometry),
(554)-[:nan]->(comment),
(554)-[:Kastell Căciulătești]->(label),
(556)-[:Point]->(type),
(556)-[:4326> POINT (20.629444 46.072222)]->(asWKT),
(556)-[:Kastell Sânnicolau Mare Geometry]->(label),
(559)-[:Point]->(type),
(559)-[:4326> POINT (24.917722 44.172583)]->(asWKT),
(559)-[:Kastell Gresia Geometry]->(label),
(562)-[:Point]->(type),
(562)-[:4326> POINT (25.178583 45.398444)]->(asWKT),
(562)-[:Kastell Rucăr Geometry]->(label),
(565)-[:MilitaryCamp]->(type),
(565)-[:000d5176-6b9e-4065-a44f-d7b8f75b1199_geom]->(hasGeometry),
(565)-[:nan]->(comment),
(565)-[:Kastell Orăştioara de Sus]->(label),
(567)-[:MilitaryCamp]->(type),
(567)-[:9ac48ee9-00b6-46ab-a597-b6aa5f2d784a_geom]->(hasGeometry),
(567)-[:nan]->(comment),
(567)-[:Kastell Bivolari (Arutela)]->(label),
(569)-[:Point]->(type),
(569)-[:4326> POINT (24.761417 44.485833)]->(asWKT),
(569)-[:Kastell Urluieni I Geometry]->(label),
(572)-[:Point]->(type),
(572)-[:4326> POINT (24.763694 44.707917)]->(asWKT),
(572)-[:Kastell Săpata de Jos II Geometry]->(label),
(575)-[:MilitaryCamp]->(type),
(575)-[:3b51185a-d7ca-4c22-b85d-a021b3727c4d_geom]->(hasGeometry),
(575)-[:nan]->(comment),
(575)-[:Kastell Brâncoveneşti]->(label),
(577)-[:Point]->(type),
(577)-[:4326> POINT (23.098056 44.9075)]->(asWKT),
(577)-[:Kastell Pinoasa Geometry]->(label),
(580)-[:Point]->(type),
(580)-[:4326> POINT (25.121806 46.431319)]->(asWKT),
(580)-[:Kastell Inlăceni Geometry]->(label),
(583)-[:MilitaryCamp]->(type),
(583)-[:b6e369cd-722a-4a1c-a984-538bb26f3777_geom]->(hasGeometry),
(583)-[:Kohortenkastell]->(comment),
(583)-[:Kastell Buciumi]->(label),
(585)-[:Point]->(type),
(585)-[:4326> POINT (20.145953 46.253697)]->(asWKT),
(585)-[:Kastell Szeged Geometry]->(label),
(588)-[:MilitaryCamp]->(type),
(588)-[:fb3dfa9f-ac48-4ced-a8dc-2b635594cfdd_geom]->(hasGeometry),
(588)-[:Kohortenkastell]->(comment),
(588)-[:Kastell Vărădia]->(label),
(590)-[:Point]->(type),
(590)-[:4326> POINT (26.312836 46.050994)]->(asWKT),
(590)-[:Kastell Brețcu Geometry]->(label),
(593)-[:Point]->(type),
(593)-[:4326> POINT (23.899911 47.019833)]->(asWKT),
(593)-[:Kastell Gherla Geometry]->(label),
(596)-[:MilitaryCamp]->(type),
(596)-[:0e91c0e7-3991-4a45-89ed-382f7c74731a_geom]->(hasGeometry),
(596)-[:nan]->(comment),
(596)-[:Kastell Săpata de Jos II]->(label),
(598)-[:MilitaryCamp]->(type),
(598)-[:7dd1742c-a3a5-4494-b148-1d435d754d5d_geom]->(hasGeometry),
(598)-[:  Alenkastell]->(comment),
(598)-[:Kastell Vršac]->(label),
(601)-[:Point]->(type),
(601)-[:4326> POINT (21.315097 46.146819)]->(asWKT),
(601)-[:Kastell Aradul Nou Geometry]->(label),
(604)-[:Point]->(type),
(604)-[:4326> POINT (24.373611 45.173611)]->(asWKT),
(604)-[:Kastell Sămbotin (Castra Traiana) Geometry]->(label),
(607)-[:Point]->(type),
(607)-[:4326> POINT (25.379472 46.194833)]->(asWKT),
(607)-[:Kastell Sânpaul Geometry]->(label),
(610)-[:Point]->(type),
(610)-[:4326> POINT (23.949167 43.938056)]->(asWKT),
(610)-[:Kastell Căciulătești Geometry]->(label),
(613)-[:MilitaryCamp]->(type),
(613)-[:c3451d14-c4ee-42be-b918-af9735167f5f_geom]->(hasGeometry),
(613)-[:nan]->(comment),
(613)-[:Kastell Sarateni]->(label)
