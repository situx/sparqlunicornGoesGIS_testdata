...
(0)-[:0ab5e10e-4fb0-4854-835b-389043840ee0_geom]->(hasGeometry),
(0)-[:nan]->(comment),
(0)-[:Kastell Lişteava]->(label),
(5)-[:Point]->(type),
(5)-[:4326> POINT (24.528969 44.081789)]->(asWKT),
(5)-[:Kastell Slăveni Geometry]->(label),
(9)-[:Point]->(type),
(9)-[:4326> POINT (24.394444 45.409722)]->(asWKT),
(9)-[:Kastell Titeşti Geometry]->(label),
(12)-[:MilitaryCamp]->(type),
(12)-[:0fe1d8dd-b425-4d55-ae80-2cd8d5d61ace_geom]->(hasGeometry),
(12)-[:nan]->(comment),
(12)-[:Kastell Căşeiu (Samum)]->(label),
(15)-[:Point]->(type),
(15)-[:4326> POINT (25.379472 46.194833)]->(asWKT),
(15)-[:Kastell Sânpaul Geometry]->(label),
(18)-[:MilitaryCamp]->(type),
(18)-[:3b51185a-d7ca-4c22-b85d-a021b3727c4d_geom]->(hasGeometry),
(18)-[:nan]->(comment),
(18)-[:Kastell Brâncoveneşti]->(label),
(21)-[:Point]->(type),
(21)-[:4326> POINT (24.8945 44.958083)]->(asWKT),
(21)-[:Kastell Purcăreni Geometry]->(label),
(24)-[:MilitaryCamp]->(type),
(24)-[:cba75304-f136-465d-90fb-56dff3acc018_geom]->(hasGeometry),
(24)-[:nan]->(comment),
(24)-[:Kastell Enoşeşti (Acidava)]->(label),
(27)-[:Point]->(type),
(27)-[:4326> POINT (25.012472 45.22075)]->(asWKT),
(27)-[:Kastell Câmpulung Muscel I Geometry]->(label),
(30)-[:MilitaryCamp]->(type),
(30)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2_geom]->(hasGeometry),
(30)-[:nan]->(comment),
(30)-[:Kastell Câmpulung Muscel II]->(label),
(33)-[:Point]->(type),
(33)-[:4326> POINT (21.551161 45.079397)]->(asWKT),
(33)-[:Kastell Vărădia Geometry]->(label),
(36)-[:MilitaryCamp]->(type),
(36)-[:7422f9df-da23-450f-8eac-db2d8dfca42e_geom]->(hasGeometry),
(36)-[:nan]->(comment),
(36)-[:Kastell Livezile]->(label),
(39)-[:MilitaryCamp]->(type),
(39)-[:9f76d5fd-4ee3-4985-9fb6-c22bfdf43436_geom]->(hasGeometry),
(39)-[:nan]->(comment),
(39)-[:Kastell Putineiu]->(label),
(42)-[:FeatureCollection]->(type),
(42)-[:LegionaryCamp Instances Collection]->(label),
(42)-[:5709a2bb-8d86-44af-b582-19151b918068]->(member),
(42)-[:ffd99607-0513-4fa5-8073-c80bddbfab84]->(member),
(42)-[:497eff64-e309-4704-b5f0-3e2872ff379d]->(member),
(42)-[:fddcce1d-ea5f-4dc2-a2d1-740ca41fa97e]->(member),
(42)-[:7e6b0abd-392e-48da-a973-52db57e43459]->(member),
(42)-[:87009579-c2cc-4c7a-9b02-901bf75a0ee6]->(member),
(42)-[:64755b3a-9ff6-4c12-b9fb-778e3bde5b1f]->(member),
(52)-[:Point]->(type),
(52)-[:4326> POINT (25.900222 45.844172)]->(asWKT),
(52)-[:Kastell Comalău Geometry]->(label),
(55)-[:MilitaryCamp]->(type),
(55)-[:340738ca-7444-4896-a0fd-cd9e6806eb30_geom]->(hasGeometry),
(55)-[:nan]->(comment),
(55)-[:Kastell Mehadia (Praetorium)]->(label),
(58)-[:MilitaryCamp]->(type),
(58)-[:a6ec226a-3c2a-444a-9221-839201e1135f_geom]->(hasGeometry),
(58)-[:nan]->(comment),
(58)-[:Kastell Săpata de Jos I]->(label),
(61)-[:Point]->(type),
(61)-[:4326> POINT (22.1895 45.4663)]->(asWKT),
(61)-[:Kastell Tibiscum Geometry]->(label),
(64)-[:Point]->(type),
(64)-[:4326> POINT (24.360675 45.105944)]->(asWKT),
(64)-[:Kastell Stolniceni Geometry]->(label),
(67)-[:Point]->(type),
(67)-[:4326> POINT (23.098056 44.9075)]->(asWKT),
(67)-[:Kastell Pinoasa Geometry]->(label),
(70)-[:Point]->(type),
(70)-[:4326> POINT (23.571889 44.514111)]->(asWKT),
(70)-[:Kastell Mofleni (Pelendava) Geometry]->(label),
(73)-[:MilitaryCamp]->(type),
(73)-[:42d9c007-47e1-4b2a-ab2c-c381f93cac96_geom]->(hasGeometry),
(73)-[:Auxiliarkastell]->(comment),
(73)-[:Kastell Grebenac]->(label),
(77)-[:Point]->(type),
(77)-[:4326> POINT (24.476111 46.510556)]->(asWKT),
(77)-[:Kastell Cristeşti Geometry]->(label),
(80)-[:MilitaryCamp]->(type),
(80)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2_geom]->(hasGeometry),
(80)-[:Kohortenkastell]->(comment),
(80)-[:Kastell Inlăceni]->(label),
(84)-[:Point]->(type),
(84)-[:4326> POINT (24.266011 45.635769)]->(asWKT),
(84)-[:Kastell Boiţa (Caput Stenarum) Geometry]->(label),
(87)-[:Point]->(type),
(87)-[:4326> POINT (24.870833 43.751667)]->(asWKT),
(87)-[:Kastell Islaz-Razovica Geometry]->(label),
(90)-[:Point]->(type),
(90)-[:4326> POINT (24.016667 44.116667)]->(asWKT),
(90)-[:Kastell Castranova Geometry]->(label),
(93)-[:MilitaryCamp]->(type),
(93)-[:c8ecf3da-c535-41df-b06e-298cd8542633_geom]->(hasGeometry),
(93)-[:nan]->(comment),
(93)-[:Kastell Teregova (Ad Pannonios)]->(label),
(96)-[:Point]->(type),
(96)-[:4326> POINT (22.3522 44.9229)]->(asWKT),
(96)-[:Kastell Mehadia (Praetorium) Geometry]->(label),
(99)-[:Point]->(type),
(99)-[:4326> POINT (22.884611 46.885694)]->(asWKT),
(99)-[:Kastell Bologa (Resculum) Geometry]->(label),
(102)-[:Point]->(type),
(102)-[:4326> POINT (24.757222 43.733056)]->(asWKT),
(102)-[:Kastell Racoviţa (Praetorium II) Geometry]->(label),
(105)-[:LegionaryCamp]->(type),
(105)-[:87009579-c2cc-4c7a-9b02-901bf75a0ee6_geom]->(hasGeometry),
(105)-[:Legionslager]->(comment),
(105)-[:Kastell Vețel]->(label),
(110)-[:Point]->(type),
(110)-[:4326> POINT (24.095361 47.210528)]->(asWKT),
(110)-[:Kastell Ilişua (Arcobara) Geometry]->(label),
(113)-[:MilitaryCamp]->(type),
(113)-[:47a7d25e-6315-4256-b257-c2dfaea5e42f_geom]->(hasGeometry),
(113)-[:nan]->(comment),
(113)-[:Kastell Zăvoi (Acmonia ?)]->(label),
(116)-[:MilitaryCamp]->(type),
(116)-[:e69e6cb2-cded-446c-b159-daec78476f43_geom]->(hasGeometry),
(116)-[:nan]->(comment),
(116)-[:Kastell Căciulătești]->(label),
(119)-[:Point]->(type),
(119)-[:4326> POINT (24.651389 43.866389)]->(asWKT),
(119)-[:Kastell Tia Mare Geometry]->(label),
(122)-[:Point]->(type),
(122)-[:4326> POINT (22.786822 45.51665)]->(asWKT),
(122)-[:Kastell Sarmizegetusa (Ulpia Traiana) Geometry]->(label),
(125)-[:Point]->(type),
(125)-[:4326> POINT (24.309861 45.395903)]->(asWKT),
(125)-[:Kastell Copăceni (Praetorium I) Geometry]->(label),
(128)-[:Point]->(type),
(128)-[:4326> POINT (24.57075 47.186869)]->(asWKT),
(128)-[:Kastell Livezile Geometry]->(label),
(131)-[:Point]->(type),
(131)-[:4326> POINT (23.772733 46.570536)]->(asWKT),
(131)-[:Legionslager Potaissa Geometry]->(label),
(134)-[:MilitaryCamp]->(type),
(134)-[:7aa137c0-3763-4bd3-a1ec-bd8a88b3d786_geom]->(hasGeometry),
(134)-[:Kohortenkastell]->(comment),
(134)-[:Kastell Călugăreni]->(label),
(137)-[:Point]->(type),
(137)-[:4326> POINT (24.961889 43.935889)]->(asWKT),
(137)-[:Kastell Băneasa II Geometry]->(label),
(140)-[:Point]->(type),
(140)-[:4326> POINT (23.164364 45.897053)]->(asWKT),
(140)-[:Kastell Cigmău Geometry]->(label),
(143)-[:Point]->(type),
(143)-[:4326> POINT (24.441944 45.281528)]->(asWKT),
(143)-[:Kastell Rădăcineşti Geometry]->(label),
(146)-[:MilitaryCamp]->(type),
(146)-[:7dd1742c-a3a5-4494-b148-1d435d754d5d_geom]->(hasGeometry),
(146)-[:  Alenkastell]->(comment),
(146)-[:Kastell Vršac]->(label),
(150)-[:MilitaryCamp]->(type),
(150)-[:0ccd99fd-62d1-4978-873a-106b1f5e3880_geom]->(hasGeometry),
(150)-[:nan]->(comment),
(150)-[:Kastell Rucăr]->(label),
(153)-[:MilitaryCamp]->(type),
(153)-[:9ac48ee9-00b6-46ab-a597-b6aa5f2d784a_geom]->(hasGeometry),
(153)-[:nan]->(comment),
(153)-[:Kastell Bivolari (Arutela)]->(label),
(156)-[:Point]->(type),
(156)-[:4326> POINT (25.012694 45.221)]->(asWKT),
(156)-[:Kastell Câmpulung Muscel II Geometry]->(label),
(159)-[:MilitaryCamp]->(type),
(159)-[:ed79872f-dcb1-48d0-a008-5a3c65432a67_geom]->(hasGeometry),
(159)-[:Kohortenkastell (?)]->(comment),
(159)-[:Kastell Aradul Nou]->(label),
(163)-[:MilitaryCamp]->(type),
(163)-[:1d8f65a8-c30b-40f1-9676-2e1145691ac3_geom]->(hasGeometry),
(163)-[:nan]->(comment),
(163)-[:Kastell Abrud (Alburnus Maior)]->(label),
(166)-[:Point]->(type),
(166)-[:4326> POINT (21.331111 44.845)]->(asWKT),
(166)-[:Kastell Banatska Palanka Geometry]->(label),
(169)-[:LegionaryCamp]->(type),
(169)-[:fddcce1d-ea5f-4dc2-a2d1-740ca41fa97e_geom]->(hasGeometry),
(169)-[:Legionslager]->(comment),
(169)-[:Legionslager Alba Julia]->(label),
(172)-[:MilitaryCamp]->(type),
(172)-[:22bf9a4e-a715-43f7-9fd0-4a60b8b77288_geom]->(hasGeometry),
(172)-[:nan]->(comment),
(172)-[:Kastell Tia Mare]->(label),
(174)-[:Point]->(type),
(174)-[:4326> POINT (23.172444 47.106944)]->(asWKT),
(174)-[:Kastell Romita Geometry]->(label),
(177)-[:Point]->(type),
(177)-[:4326> POINT (23.572314 46.066694)]->(asWKT),
(177)-[:Legionslager Alba Julia Geometry]->(label),
(180)-[:MilitaryCamp]->(type),
(180)-[:f81e10af-8e41-447d-b601-dcba5311199b_geom]->(hasGeometry),
(180)-[:nan]->(comment),
(180)-[:Malva)]->(label),
(183)-[:MilitaryCamp]->(type),
(183)-[:1b4b9c1f-cb64-4c02-976d-61c2147b0705_geom]->(hasGeometry),
(183)-[:nan]->(comment),
(183)-[:Kastell Râul Vadului]->(label),
(186)-[:MilitaryCamp]->(type),
(186)-[:50320dbe-929c-40e3-aebd-f8f257d6472a_geom]->(hasGeometry),
(186)-[:nan]->(comment),
(186)-[:Kastell Castranova]->(label),
(188)-[:Point]->(type),
(188)-[:4326> POINT (23.571847 44.514)]->(asWKT),
(188)-[:Kastell Răcarii de Jos Geometry]->(label),
(191)-[:MilitaryCamp]->(type),
(191)-[:6c5d4f2f-8a7b-4ad5-8672-f4ecc7e80ff0_geom]->(hasGeometry),
(191)-[:nan]->(comment),
(191)-[:Kastell Băneasa I]->(label),
(194)-[:MilitaryCamp]->(type),
(194)-[:9b62118c-9936-42f2-a6e7-49f649c937f2_geom]->(hasGeometry),
(194)-[:nan]->(comment),
(194)-[:Kastell Bumbeşti]->(label),
(197)-[:MilitaryCamp]->(type),
(197)-[:7c3bf06c-8f79-457e-b56f-77da98c7a69b_geom]->(hasGeometry),
(197)-[:nan]->(comment),
(197)-[:Kastell Băneasa II]->(label),
(199)-[:Point]->(type),
(199)-[:4326> POINT (26.016986 45.843861)]->(asWKT),
(199)-[:Kastell Borosneu Mare Geometry]->(label),
(202)-[:Point]->(type),
(202)-[:4326> POINT (24.30325 44.374806)]->(asWKT),
(202)-[:Kastell Enoşeşti (Acidava) Geometry]->(label),
(205)-[:MilitaryCamp]->(type),
(205)-[:59eaf728-6bdb-4f30-a9e7-abec5dbbaa5f_geom]->(hasGeometry),
(205)-[:Kohortenkastell (?)]->(comment),
(205)-[:Kastell Sânnicolau Mare]->(label),
(208)-[:Point]->(type),
(208)-[:4326> POINT (22.4076 44.7382)]->(asWKT),
(208)-[:Kastell Orșova (Dierna) Geometry]->(label),
(211)-[:MilitaryCamp]->(type),
(211)-[:0203af0b-bc52-4f9f-b490-b2bc3fe431fc_geom]->(hasGeometry),
(211)-[:Auxiliarkastell]->(comment),
(211)-[:Kastell Cigmău ]->(label),
(213)-[:MilitaryCamp]->(type),
(213)-[:9a084d40-bf5c-42fa-8aa7-8c678524c631_geom]->(hasGeometry),
(213)-[:nan]->(comment),
(213)-[:Kastell Racoviţa (Praetorium II)]->(label),
(215)-[:LegionaryCamp]->(type),
(215)-[:5709a2bb-8d86-44af-b582-19151b918068_geom]->(hasGeometry),
(215)-[:nan]->(comment),
(215)-[:Kastell Sarmizegetusa (Ulpia Traiana)]->(label),
(217)-[:MilitaryCamp]->(type),
(217)-[:af909713-68f5-4b6d-89d5-03f7fc7fd5c1_geom]->(hasGeometry),
(217)-[:nan]->(comment),
(217)-[:Kastell Sămbotin (Castra Traiana)]->(label),
(220)-[:MilitaryCamp]->(type),
(220)-[:7cb289bf-4a31-467d-9c9d-4271a8dc55c9_geom]->(hasGeometry),
(220)-[:nan]->(comment),
(220)-[:Kastell Boiţa (Caput Stenarum) ]->(label),
(222)-[:MilitaryCamp]->(type),
(222)-[:bd14e9f3-dd38-4329-a655-60b00fd8d5b7_geom]->(hasGeometry),
(222)-[:nan]->(comment),
(222)-[:Kastell Sighisoara]->(label),
(225)-[:MilitaryCamp]->(type),
(225)-[:3af3a2c4-8038-482d-9fa9-a0e90584ef6d_geom]->(hasGeometry),
(225)-[:Kohortenkastell (?)]->(comment),
(225)-[:Kastell Bulci]->(label),
(228)-[:Point]->(type),
(228)-[:4326> POINT (24.400833 44.166667)]->(asWKT),
(228)-[:Malva) Geometry]->(label),
(231)-[:MilitaryCamp]->(type),
(231)-[:7b05b48b-cd48-4c66-916e-6ea581179843_geom]->(hasGeometry),
(231)-[:nan]->(comment),
(231)-[:Kastell Islaz-Verdea]->(label),
(234)-[:Point]->(type),
(234)-[:4326> POINT (24.360556 45.231944)]->(asWKT),
(234)-[:Kastell Jiblea Geometry]->(label),
(237)-[:Point]->(type),
(237)-[:4326> POINT (25.300011 45.983367)]->(asWKT),
(237)-[:Kastell Hoghiz Geometry]->(label),
(240)-[:MilitaryCamp]->(type),
(240)-[:0f25c729-a3c7-4cb4-b063-ff72c0124b4f_geom]->(hasGeometry),
(240)-[:nan]->(comment),
(240)-[:Kastell Urluieni I]->(label),
(243)-[:MilitaryCamp]->(type),
(243)-[:9ba7d74c-175e-48c8-9403-dbbdd650ed22_geom]->(hasGeometry),
(243)-[:nan]->(comment),
(243)-[:Kastell Cristeşti]->(label),
(245)-[:Point]->(type),
(245)-[:4326> POINT (25.849619 45.970939)]->(asWKT),
(245)-[:Kastell Olteni Geometry]->(label),
(248)-[:Point]->(type),
(248)-[:4326> POINT (21.847883 45.486656)]->(asWKT),
(248)-[:Kastell Aizis Geometry]->(label),
(251)-[:Point]->(type),
(251)-[:4326> POINT (23.327689 47.227733)]->(asWKT),
(251)-[:Kastell Tihău Geometry]->(label),
(254)-[:Point]->(type),
(254)-[:4326> POINT (24.947028 44.074472)]->(asWKT),
(254)-[:Kastell Roșiorii de Vede Geometry]->(label),
(257)-[:Point]->(type),
(257)-[:4326> POINT (24.272806 45.523639)]->(asWKT),
(257)-[:Kastell Râul Vadului Geometry]->(label),
(260)-[:Collection]->(type),
(260)-[:FeatureCollection Instances Collection]->(label),
(260)-[:LimesDaicusFeatures]->(member),
(260)-[:LimesNoricumFeatures]->(member),
(265)-[:MilitaryCamp]->(type),
(265)-[:d2adbbd5-f4a7-471d-a817-b28e37bcbfb1_geom]->(hasGeometry),
(265)-[: Alenkastell]->(comment),
(265)-[:Kastell Banatska Palanka]->(label),
(268)-[:Point]->(type),
(268)-[:4326> POINT (21.300194 45.122669)]->(asWKT),
(268)-[:Kastell Vršac Geometry]->(label),
(271)-[:MilitaryCamp]->(type),
(271)-[:e2573931-d743-40c3-a6b7-08ffeb244daa_geom]->(hasGeometry),
(271)-[:nan]->(comment),
(271)-[:Kastell Valea Urluii]->(label),
(274)-[:MilitaryCamp]->(type),
(274)-[:7a5a0685-4a85-48f0-a5ac-7b3b56efa3dc_geom]->(hasGeometry),
(274)-[:nan]->(comment),
(274)-[:Kastell Roșiorii de Vede]->(label),
(276)-[:Point]->(type),
(276)-[:4326> POINT (25.008889 46.562222)]->(asWKT),
(276)-[:Kastell Sarateni Geometry]->(label),
(279)-[:Point]->(type),
(279)-[:4326> POINT (23.181678 47.113403)]->(asWKT),
(279)-[:Kastell Romanasi (Largiana) Geometry]->(label),
(282)-[:MilitaryCamp]->(type),
(282)-[:120e3991-1f39-4359-b810-37bb24aff05c_geom]->(hasGeometry),
(282)-[:Kohortenkastell]->(comment),
(282)-[:Kastell Romita]->(label),
(284)-[:Point]->(type),
(284)-[:4326> POINT (24.877311 46.628978)]->(asWKT),
(284)-[:Kastell Călugăreni Geometry]->(label),
(287)-[:Point]->(type),
(287)-[:4326> POINT (23.4 45.166667)]->(asWKT),
(287)-[:Kastell Bumbeşti Geometry]->(label),
(290)-[:MilitaryCamp]->(type),
(290)-[:b5cf0c45-ec51-4710-a03a-75e7dc30a7a3_geom]->(hasGeometry),
(290)-[:Kohortenkastell]->(comment),
(290)-[:Kastell Romanasi (Largiana)]->(label),
(292)-[:MilitaryCamp]->(type),
(292)-[:d92ef45f-91c4-442e-b279-61f17fbccb7c_geom]->(hasGeometry),
(292)-[:nan]->(comment),
(292)-[:Kastell Ilişua (Arcobara)]->(label),
(294)-[:Point]->(type),
(294)-[:4326> POINT (24.785111 44.603278)]->(asWKT),
(294)-[:Kastell Fâlfani Geometry]->(label),
(297)-[:Point]->(type),
(297)-[:4326> POINT (24.761417 44.485833)]->(asWKT),
(297)-[:Kastell Urluieni I Geometry]->(label),
(300)-[:Point]->(type),
(300)-[:4326> POINT (24.752103 46.239431)]->(asWKT),
(300)-[:Kastell Sighisoara Geometry]->(label),
(303)-[:MilitaryCamp]->(type),
(303)-[:e3899f66-1234-4a44-b16e-2ead1e0bf696_geom]->(hasGeometry),
(303)-[:nan]->(comment),
(303)-[:Kastell Cincsor]->(label),
(306)-[:MilitaryCamp]->(type),
(306)-[:f8305d66-9429-43c0-b6e3-73721df9986b_geom]->(hasGeometry),
(306)-[:nan]->(comment),
(306)-[:Kastell Urluieni II]->(label),
(309)-[:MilitaryCamp]->(type),
(309)-[:000d5176-6b9e-4065-a44f-d7b8f75b1199_geom]->(hasGeometry),
(309)-[:nan]->(comment),
(309)-[:Kastell Orăştioara de Sus]->(label),
(312)-[:MilitaryCamp]->(type),
(312)-[:707cb61a-d04e-4c7b-a620-6587db82f116_geom]->(hasGeometry),
(312)-[:nan]->(comment),
(312)-[:Kastell Purcăreni]->(label),
(314)-[:Point]->(type),
(314)-[:4326> POINT (24.762111 44.484583)]->(asWKT),
(314)-[:Kastell Urluieni II Geometry]->(label),
(317)-[:MilitaryCamp]->(type),
(317)-[:06eb8de4-750e-4ed9-ad04-9bf16d61c975_geom]->(hasGeometry),
(317)-[:nan]->(comment),
(317)-[:Kastell Momoteşti (Rusidava)]->(label),
(320)-[:Point]->(type),
(320)-[:4326> POINT (24.917722 44.172583)]->(asWKT),
(320)-[:Kastell Gresia Geometry]->(label),
(323)-[:Point]->(type),
(323)-[:4326> POINT (24.866611 45.842519)]->(asWKT),
(323)-[:Kastell Cincsor Geometry]->(label),
(326)-[:Point]->(type),
(326)-[:4326> POINT (25.121806 46.431319)]->(asWKT),
(326)-[:Kastell Inlăceni Geometry]->(label),
(329)-[:MilitaryCamp]->(type),
(329)-[:9d1c0c0d-98f5-4728-86ee-4288dde6d0fa_geom]->(hasGeometry),
(329)-[:Kohortenkastell]->(comment),
(329)-[:Kastell Râșnov ]->(label),
(332)-[:Point]->(type),
(332)-[:4326> POINT (22.112283 46.006539)]->(asWKT),
(332)-[:Kastell Bulci Geometry]->(label),
(335)-[:MilitaryCamp]->(type),
(335)-[:815f5c63-8478-4aac-bafb-11eaafa9a923_geom]->(hasGeometry),
(335)-[:Auxiliarkastell]->(comment),
(335)-[:Kastell Dupljaja]->(label),
(338)-[:MilitaryCamp]->(type),
(338)-[:86dae60a-c827-480d-bb38-04a480b9ea01_geom]->(hasGeometry),
(338)-[:Kohortenkastell (?)]->(comment),
(338)-[:Kastell Cenad]->(label),
(341)-[:Point]->(type),
(341)-[:4326> POINT (25.441581 45.618708)]->(asWKT),
(341)-[:Kastell Râșnov Geometry]->(label),
(344)-[:GeometryCollection]->(type),
(344)-[:aadec8db-70f9-4c40-833a-2a7c39c631d2_geom]->(member),
(344)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2_geom]->(member),
(344)-[:b6e369cd-722a-4a1c-a984-538bb26f3777_geom]->(member),
(344)-[:c3a471a8-ab67-4e9c-b127-1eff017b0cb4_geom]->(member),
(344)-[:cba75304-f136-465d-90fb-56dff3acc018_geom]->(member),
(344)-[:d2adbbd5-f4a7-471d-a817-b28e37bcbfb1_geom]->(member),
(344)-[:d92ef45f-91c4-442e-b279-61f17fbccb7c_geom]->(member),
(344)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2_geom]->(member),
(344)-[:815f5c63-8478-4aac-bafb-11eaafa9a923_geom]->(member),
(344)-[:86dae60a-c827-480d-bb38-04a480b9ea01_geom]->(member),
(344)-[:9ac48ee9-00b6-46ab-a597-b6aa5f2d784a_geom]->(member),
(344)-[:9b62118c-9936-42f2-a6e7-49f649c937f2_geom]->(member),
(344)-[:9ba7d74c-175e-48c8-9403-dbbdd650ed22_geom]->(member),
(344)-[:Limes Daicus Geometries]->(label),
(359)-[:Point]->(type),
(359)-[:4326> POINT (22.410833 45.525278)]->(asWKT),
(359)-[:Kastell Zăvoi (Acmonia ?) Geometry]->(label),
(362)-[:Point]->(type),
(362)-[:4326> POINT (23.37 45.18)]->(asWKT),
(362)-[:Kastell Plesa Geometry]->(label),
(365)-[:Point]->(type),
(365)-[:4326> POINT (21.275078 44.927103)]->(asWKT),
(365)-[:Kastell Dupljaja Geometry]->(label),
(368)-[:MilitaryCamp]->(type),
(368)-[:fb3dfa9f-ac48-4ced-a8dc-2b635594cfdd_geom]->(hasGeometry),
(368)-[:Kohortenkastell]->(comment),
(368)-[:Kastell Vărădia]->(label),
(370)-[:MilitaryCamp]->(type),
(370)-[:5a43030f-b985-4444-8cf9-3e4a0b132d79_geom]->(hasGeometry),
(370)-[:nan]->(comment),
(370)-[:Kastell Vârtop]->(label),
(373)-[:MilitaryCamp]->(type),
(373)-[:aadec8db-70f9-4c40-833a-2a7c39c631d2_geom]->(hasGeometry),
(373)-[:nan]->(comment),
(373)-[:Kastell Cătunele]->(label),
(375)-[:Point]->(type),
(375)-[:4326> POINT (24.312389 45.309667)]->(asWKT),
(375)-[:Kastell Bivolari (Arutela) Geometry]->(label),
(378)-[:MilitaryCamp]->(type),
(378)-[:b0524f84-a9d2-45fa-9f69-d8164ad73440_geom]->(hasGeometry),
(378)-[:Kohortenkastell]->(comment),
(378)-[:Kastell Olteni]->(label),
(380)-[:MilitaryCamp]->(type),
(380)-[:3f7e0b8c-1a5f-423f-85da-536d87bbdcc8_geom]->(hasGeometry),
(380)-[:nan]->(comment),
(380)-[:Kastell Orheiul Bistriţei]->(label),
(383)-[:Point]->(type),
(383)-[:4326> POINT (24.763556 44.707333)]->(asWKT),
(383)-[:Kastell Săpata de Jos I Geometry]->(label),
(386)-[:MilitaryCamp]->(type),
(386)-[:01189de6-024d-4022-96ff-eec7e4efee0c_geom]->(hasGeometry),
(386)-[:nan]->(comment),
(386)-[:Kastell Orșova (Dierna)]->(label),
(388)-[:Point]->(type),
(388)-[:4326> POINT (23.372222 45.1825)]->(asWKT),
(388)-[:Kastell Vârtop Geometry]->(label),
(391)-[:Collection]->(type),
(391)-[:GeometryCollection Instances Collection]->(label),
(391)-[:LimesDaicusGeometries]->(member),
(391)-[:LimesNoricumGeometries]->(member),
(394)-[:MilitaryCamp]->(type),
(394)-[:322e89c0-f571-4be4-a08c-84b35efb69e5_geom]->(hasGeometry),
(394)-[:nan]->(comment),
(394)-[:Kastell Sânpaul]->(label),
(396)-[:MilitaryCamp]->(type),
(396)-[:1795d125-e071-4153-b07e-e147bb19ad65_geom]->(hasGeometry),
(396)-[:nan]->(comment),
(396)-[:Kastell Comalău]->(label),
(398)-[:MilitaryCamp]->(type),
(398)-[:1c936059-6af8-4f03-8e18-cc61f529c5f3_geom]->(hasGeometry),
(398)-[:Auxiliarkastelle]->(comment),
(398)-[:Kastelle von Porolissum]->(label),
(402)-[:MilitaryCamp]->(type),
(402)-[:8f823c04-d42b-49ec-879d-2c446d575885_geom]->(hasGeometry),
(402)-[:nan]->(comment),
(402)-[:Kastell Voineşti]->(label),
(405)-[:Point]->(type),
(405)-[:4326> POINT (23.92 43.834167)]->(asWKT),
(405)-[:Kastell Lişteava Geometry]->(label),
(408)-[:Point]->(type),
(408)-[:4326> POINT (25.178583 45.398444)]->(asWKT),
(408)-[:Kastell Rucăr Geometry]->(label),
(411)-[:FeatureCollection]->(type),
(411)-[:aadec8db-70f9-4c40-833a-2a7c39c631d2]->(member),
(411)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2]->(member),
(411)-[:b6e369cd-722a-4a1c-a984-538bb26f3777]->(member),
(411)-[:c3a471a8-ab67-4e9c-b127-1eff017b0cb4]->(member),
(411)-[:cba75304-f136-465d-90fb-56dff3acc018]->(member),
(411)-[:d2adbbd5-f4a7-471d-a817-b28e37bcbfb1]->(member),
(411)-[:d92ef45f-91c4-442e-b279-61f17fbccb7c]->(member),
(411)-[:e0423dfe-4fdf-4bf6-8453-97d7bee4d031]->(member),
(411)-[:e3899f66-1234-4a44-b16e-2ead1e0bf696]->(member),
(411)-[:e69e6cb2-cded-446c-b159-daec78476f43]->(member),
(411)-[:e811fe5a-92d2-43a0-a572-51bc5942e242]->(member),
(411)-[:ed79872f-dcb1-48d0-a008-5a3c65432a67]->(member),
(411)-[:f35f2d3f-8925-4139-9e9b-cf07ee5aaecb]->(member),
(411)-[:0ab5e10e-4fb0-4854-835b-389043840ee0]->(member),
(411)-[:0fe1d8dd-b425-4d55-ae80-2cd8d5d61ace]->(member),
(411)-[:0203af0b-bc52-4f9f-b490-b2bc3fe431fc]->(member),
(411)-[:096a9a4c-020f-4ce0-a4a6-993d50d08fea]->(member),
(411)-[:1d8f65a8-c30b-40f1-9676-2e1145691ac3]->(member),
(411)-[:1e218e82-f264-4241-a8e0-5efd9a1ec8a4]->(member),
(411)-[:1795d125-e071-4153-b07e-e147bb19ad65]->(member),
(411)-[:3af3a2c4-8038-482d-9fa9-a0e90584ef6d]->(member),
(411)-[:3b51185a-d7ca-4c22-b85d-a021b3727c4d]->(member),
(411)-[:34d0d768-2d4d-42b3-82ae-e29bad5c1eed]->(member),
(411)-[:3680e065-f377-4f4d-a9d6-84523dcb1727]->(member),
(411)-[:4dbfae9e-f0f7-4dab-94ca-9bca2cec83aa]->(member),
(411)-[:4df4edbc-facd-42bd-b05e-076f94ae693b]->(member),
(411)-[:4e013c45-7445-4ea6-8356-2c9cc9e7ac6e]->(member),
(411)-[:4198c975-e14a-4fb3-9b2e-7be9e145ecac]->(member),
(411)-[:5b90b8d5-ba6e-4789-94d2-db823824acbf]->(member),
(411)-[:5d0fac8e-53ae-4ae7-92a2-dd419eee0dce]->(member),
(411)-[:5e6a65c9-32dd-4581-b6ab-a95afdc4d061]->(member),
(411)-[:5ea0f057-026f-4556-97f5-3e0e3a9471c3]->(member),
(411)-[:50320dbe-929c-40e3-aebd-f8f257d6472a]->(member),
(411)-[:6c5d4f2f-8a7b-4ad5-8672-f4ecc7e80ff0]->(member),
(411)-[:64ae9ea8-9dca-4e22-b32b-c2f95fd80b44]->(member),
(411)-[:6689fc0e-01ff-4dbc-b3ed-49e35a3d397a]->(member),
(411)-[:7aa137c0-3763-4bd3-a1ec-bd8a88b3d786]->(member),
(411)-[:7b05b48b-cd48-4c66-916e-6ea581179843]->(member),
(411)-[:7c3bf06c-8f79-457e-b56f-77da98c7a69b]->(member),
(411)-[:7cb289bf-4a31-467d-9c9d-4271a8dc55c9]->(member),
(411)-[:7e6b0abd-392e-48da-a973-52db57e43459]->(member),
(411)-[:70d51242-571e-43ce-bd01-3bffca8cb4be]->(member),
(411)-[:7422f9df-da23-450f-8eac-db2d8dfca42e]->(member),
(411)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2]->(member),
(411)-[:815f5c63-8478-4aac-bafb-11eaafa9a923]->(member),
(411)-[:86dae60a-c827-480d-bb38-04a480b9ea01]->(member),
(411)-[:9ac48ee9-00b6-46ab-a597-b6aa5f2d784a]->(member),
(411)-[:9b62118c-9936-42f2-a6e7-49f649c937f2]->(member),
(411)-[:9ba7d74c-175e-48c8-9403-dbbdd650ed22]->(member),
(411)-[:Limes Daicus Features]->(label),
(433)-[:Point]->(type),
(433)-[:4326> POINT (24.27 44.650306)]->(asWKT),
(433)-[:Kastell Momoteşti (Rusidava) Geometry]->(label),
(436)-[:MilitaryCamp]->(type),
(436)-[:c3451d14-c4ee-42be-b918-af9735167f5f_geom]->(hasGeometry),
(436)-[:nan]->(comment),
(436)-[:Kastell Sarateni]->(label),
(438)-[:Point]->(type),
(438)-[:4326> POINT (23.068611 46.272222)]->(asWKT),
(438)-[:Kastell Abrud (Alburnus Maior) Geometry]->(label),
(441)-[:Point]->(type),
(441)-[:4326> POINT (23.837639 47.186222)]->(asWKT),
(441)-[:Kastell Căşeiu (Samum) Geometry]->(label),
(444)-[:Point]->(type),
(444)-[:4326> POINT (24.400833 45.370833)]->(asWKT),
(444)-[:Kastell Perisani Geometry]->(label),
(447)-[:MilitaryCamp]->(type),
(447)-[:f35f2d3f-8925-4139-9e9b-cf07ee5aaecb_geom]->(hasGeometry),
(447)-[:nan]->(comment),
(447)-[:Kastell Borosneu Mare]->(label),
(449)-[:LegionaryCamp]->(type),
(449)-[:497eff64-e309-4704-b5f0-3e2872ff379d_geom]->(hasGeometry),
(449)-[:Legionslager]->(comment),
(449)-[:Legionslager Potaissa]->(label),
(451)-[:MilitaryCamp]->(type),
(451)-[:3680e065-f377-4f4d-a9d6-84523dcb1727_geom]->(hasGeometry),
(451)-[:Kohortenkastell]->(comment),
(451)-[:Kastell Brețcu ]->(label),
(453)-[:Point]->(type),
(453)-[:4326> POINT (26.312836 46.050994)]->(asWKT),
(453)-[:Kastell Brețcu Geometry]->(label),
(456)-[:Point]->(type),
(456)-[:4326> POINT (20.629444 46.072222)]->(asWKT),
(456)-[:Kastell Sânnicolau Mare Geometry]->(label),
(459)-[:Point]->(type),
(459)-[:4326> POINT (21.315097 46.146819)]->(asWKT),
(459)-[:Kastell Aradul Nou Geometry]->(label),
(462)-[:MilitaryCamp]->(type),
(462)-[:8fa245f8-ffe5-4e74-b259-410c7be91afd_geom]->(hasGeometry),
(462)-[:nan]->(comment),
(462)-[:Kastell Titeşti]->(label),
(464)-[:Point]->(type),
(464)-[:4326> POINT (23.166667 45.733333)]->(asWKT),
(464)-[:Kastell Orăştioara de Sus Geometry]->(label),
(467)-[:MilitaryCamp]->(type),
(467)-[:e0423dfe-4fdf-4bf6-8453-97d7bee4d031_geom]->(hasGeometry),
(467)-[:nan]->(comment),
(467)-[:Kastell Ghioca]->(label),
(469)-[:Point]->(type),
(469)-[:4326> POINT (25.3002 46.3131)]->(asWKT),
(469)-[:Kastell Odorheiul Secuiesc Geometry]->(label),
(472)-[:Point]->(type),
(472)-[:4326> POINT (24.8375 44.771389)]->(asWKT),
(472)-[:Kastell Albota Geometry]->(label),
(475)-[:MilitaryCamp]->(type),
(475)-[:b6e369cd-722a-4a1c-a984-538bb26f3777_geom]->(hasGeometry),
(475)-[:Kohortenkastell]->(comment),
(475)-[:Kastell Buciumi]->(label),
(477)-[:MilitaryCamp]->(type),
(477)-[:5b90b8d5-ba6e-4789-94d2-db823824acbf_geom]->(hasGeometry),
(477)-[:nan]->(comment),
(477)-[:Kastell Căineni (Pons Vetus ?)]->(label),
(479)-[:MilitaryCamp]->(type),
(479)-[:f42bb013-afeb-4044-9886-ece53cc813d4_geom]->(hasGeometry),
(479)-[:Auxiliarkastell]->(comment),
(479)-[:Kastell Sutoru]->(label),
(482)-[:Point]->(type),
(482)-[:4326> POINT (21.629394 45.426539)]->(asWKT),
(482)-[:Kastell Berzovia Geometry]->(label),
(485)-[:MilitaryCamp]->(type),
(485)-[:5ea0f057-026f-4556-97f5-3e0e3a9471c3_geom]->(hasGeometry),
(485)-[:Alenkastell]->(comment),
(485)-[:Kastell Gherla]->(label),
(488)-[:MilitaryCamp]->(type),
(488)-[:096a9a4c-020f-4ce0-a4a6-993d50d08fea_geom]->(hasGeometry),
(488)-[:nan]->(comment),
(488)-[:Kastell Copăceni (Praetorium I)]->(label),
(490)-[:Point]->(type),
(490)-[:4326> POINT (24.96525 43.937806)]->(asWKT),
(490)-[:Kastell Băneasa I Geometry]->(label),
(493)-[:Point]->(type),
(493)-[:4326> POINT (24.763694 44.707917)]->(asWKT),
(493)-[:Kastell Săpata de Jos II Geometry]->(label),
(496)-[:MilitaryCamp]->(type),
(496)-[:5e6a65c9-32dd-4581-b6ab-a95afdc4d061_geom]->(hasGeometry),
(496)-[:nan]->(comment),
(496)-[:Kastell Câmpulung Muscel I]->(label),
(498)-[:Point]->(type),
(498)-[:4326> POINT (21.232794 44.897786)]->(asWKT),
(498)-[:Kastell Grebenac Geometry]->(label),
(501)-[:Point]->(type),
(501)-[:4326> POINT (24.762222 43.710278)]->(asWKT),
(501)-[:Kastell Islaz-Verdea Geometry]->(label),
(504)-[:MilitaryCamp]->(type),
(504)-[:9a118e00-be2c-4c2d-a9f9-8cb86170e3d1_geom]->(hasGeometry),
(504)-[:nan]->(comment),
(504)-[:Kastell Rădăcineşti]->(label),
(506)-[:MilitaryCamp]->(type),
(506)-[:5d0fac8e-53ae-4ae7-92a2-dd419eee0dce_geom]->(hasGeometry),
(506)-[:Auxiliarkastell]->(comment),
(506)-[:Kastell Hoghiz]->(label),
(508)-[:Point]->(type),
(508)-[:4326> POINT (23.868333 46.417222)]->(asWKT),
(508)-[:Kastell Războieni Geometry]->(label),
(511)-[:Point]->(type),
(511)-[:4326> POINT (23.949167 43.938056)]->(asWKT),
(511)-[:Kastell Căciulătești Geometry]->(label),
(514)-[:MilitaryCamp]->(type),
(514)-[:4df4edbc-facd-42bd-b05e-076f94ae693b_geom]->(hasGeometry),
(514)-[:nan]->(comment),
(514)-[:Kastell IIoneștii Govorii (Pons Aluti)]->(label),
(516)-[:Point]->(type),
(516)-[:4326> POINT (20.145953 46.253697)]->(asWKT),
(516)-[:Kastell Szeged Geometry]->(label),
(519)-[:Point]->(type),
(519)-[:4326> POINT (24.965361 43.897806)]->(asWKT),
(519)-[:Kastell Putineiu Geometry]->(label),
(522)-[:MilitaryCamp]->(type),
(522)-[:34d0d768-2d4d-42b3-82ae-e29bad5c1eed_geom]->(hasGeometry),
(522)-[:nan]->(comment),
(522)-[:Kastell Gresia]->(label),
(524)-[:FeatureCollection]->(type),
(524)-[:MilitaryCamp Instances Collection]->(label),
(524)-[:0ab5e10e-4fb0-4854-835b-389043840ee0]->(member),
(524)-[:0fe1d8dd-b425-4d55-ae80-2cd8d5d61ace]->(member),
(524)-[:3b51185a-d7ca-4c22-b85d-a021b3727c4d]->(member),
(524)-[:cba75304-f136-465d-90fb-56dff3acc018]->(member),
(524)-[:8c5f1f84-f11a-48f0-8e9a-c629c7d346e2]->(member),
(524)-[:7422f9df-da23-450f-8eac-db2d8dfca42e]->(member),
(524)-[:9f76d5fd-4ee3-4985-9fb6-c22bfdf43436]->(member),
(524)-[:340738ca-7444-4896-a0fd-cd9e6806eb30]->(member),
(524)-[:a6ec226a-3c2a-444a-9221-839201e1135f]->(member),
(524)-[:42d9c007-47e1-4b2a-ab2c-c381f93cac96]->(member),
(524)-[:ae458e0d-85d0-4756-b265-db4db5bb7fe2]->(member),
(524)-[:c8ecf3da-c535-41df-b06e-298cd8542633]->(member),
(524)-[:47a7d25e-6315-4256-b257-c2dfaea5e42f]->(member),
(524)-[:e69e6cb2-cded-446c-b159-daec78476f43]->(member),
(524)-[:46e40ed7-3b02-4bb3-ba5c-8dcb5f55b990]->(member),
(524)-[:5e33b468-4135-46b4-babc-99f5c423f966]->(member),
(524)-[:7cadca30-bfd9-4628-9916-c20eecafa356]->(member),
(524)-[:7aa137c0-3763-4bd3-a1ec-bd8a88b3d786]->(member),
(524)-[:64ae9ea8-9dca-4e22-b32b-c2f95fd80b44]->(member),
(524)-[:0e8a5ba3-887e-4540-92c3-d35fef2bd579]->(member),
(524)-[:0f5c8dda-88a9-48ad-bf8f-e72f216a4066]->(member),
(524)-[:13572025-f4dc-4503-8aad-72050202752b]->(member),
(524)-[:2bf44917-dd67-4ec8-9240-513476cdb60c]->(member),
(524)-[:78b044f5-8a10-47ed-acf0-74658affbf22]->(member),
(524)-[:8f964055-7a95-4e88-bcef-5bd3a5824de9]->(member),
(524)-[:9f8f4e96-12d9-449b-b9ab-6e6080e34c9f]->(member),
(524)-[:b3e7d110-127b-45a7-9195-5e8a694e4862]->(member),
(524)-[:cfcfa4b0-501f-4563-8157-3c76054014a4]->(member),
(524)-[:d0ef2a62-6c85-44ce-a995-65ab6d5a5f43]->(member),
(524)-[:d151609e-cb90-4faf-a74b-54d2f52e01a1]->(member),
(524)-[:d8bcb543-3948-43fd-937b-2782138b9deb]->(member),
(551)-[:MilitaryCamp]->(type),
(551)-[:e811fe5a-92d2-43a0-a572-51bc5942e242_geom]->(hasGeometry),
(551)-[:nan]->(comment),
(551)-[:Kastell Aizis]->(label),
(553)-[:MilitaryCamp]->(type),
(553)-[:ec646e12-636f-4c8c-96c2-0f46833adf1c_geom]->(hasGeometry),
(553)-[:Auxiliarkastell]->(comment),
(553)-[:Kastell Răcarii de Jos]->(label),
(555)-[:Point]->(type),
(555)-[:4326> POINT (24.308611 45.495)]->(asWKT),
(555)-[:Kastell Căineni (Pons Vetus ?) Geometry]->(label),
(558)-[:Point]->(type),
(558)-[:4326> POINT (24.766042 46.861514)]->(asWKT),
(558)-[:Kastell Brâncoveneşti Geometry]->(label),
(561)-[:Point]->(type),
(561)-[:4326> POINT (22.814906 45.914594)]->(asWKT),
(561)-[:Kastell Vețel Geometry]->(label),
(564)-[:Point]->(type),
(564)-[:4326> POINT (24.236111 44.883333)]->(asWKT),
(564)-[:Kastell IIoneștii Govorii (Pons Aluti) Geometry]->(label),
(567)-[:Point]->(type),
(567)-[:4326> POINT (23.899911 47.019833)]->(asWKT),
(567)-[:Kastell Gherla Geometry]->(label),
(570)-[:MilitaryCamp]->(type),
(570)-[:4dbfae9e-f0f7-4dab-94ca-9bca2cec83aa_geom]->(hasGeometry),
(570)-[:nan]->(comment),
(570)-[:Kastell Flămănda (Poiana)]->(label),
(572)-[:Point]->(type),
(572)-[:4326> POINT (24.937389 44.061333)]->(asWKT),
(572)-[:Kastell Valea Urluii Geometry]->(label),
(575)-[:MilitaryCamp]->(type),
(575)-[:918ef494-4408-4a91-8ee0-61f6087ffee7_geom]->(hasGeometry),
(575)-[:nan]->(comment),
(575)-[:Kastell Surducul Mare]->(label),
(578)-[:MilitaryCamp]->(type),
(578)-[:bf339c52-9ac1-4b87-94ab-2dc33bc7d3e4_geom]->(hasGeometry),
(578)-[:nan]->(comment),
(578)-[:Kastell Odorheiul Secuiesc]->(label),
(580)-[:Point]->(type),
(580)-[:4326> POINT (25.076083 45.297833)]->(asWKT),
(580)-[:Kastell Voineşti Geometry]->(label),
(583)-[:MilitaryCamp]->(type),
(583)-[:10b043a5-bb2b-48af-a168-84046185d6f7_geom]->(hasGeometry),
(583)-[:nan]->(comment),
(583)-[:Kastell Pinoasa]->(label),
(585)-[:Point]->(type),
(585)-[:4326> POINT (23.251667 46.986086)]->(asWKT),
(585)-[:Kastell Sutoru Geometry]->(label),
(588)-[:MilitaryCamp]->(type),
(588)-[:4198c975-e14a-4fb3-9b2e-7be9e145ecac_geom]->(hasGeometry),
(588)-[:nan]->(comment),
(588)-[:Kastell Jiblea]->(label),
(590)-[:MilitaryCamp]->(type),
(590)-[:0e91c0e7-3991-4a45-89ed-382f7c74731a_geom]->(hasGeometry),
(590)-[:nan]->(comment),
(590)-[:Kastell Săpata de Jos II]->(label),
(592)-[:MilitaryCamp]->(type),
(592)-[:986efe66-cf8a-4b64-a488-ad95d0f2dd79_geom]->(hasGeometry),
(592)-[:Kohortenkastell]->(comment),
(592)-[:Kastell Tihău]->(label),
(594)-[:MilitaryCamp]->(type),
(594)-[:2c2fb600-f249-469e-a025-1961edf5132d_geom]->(hasGeometry),
(594)-[:nan]->(comment),
(594)-[:Kastell Războieni]->(label),
(596)-[:Point]->(type),
(596)-[:4326> POINT (25.591561 45.816419)]->(asWKT),
(596)-[:Kastell Feldioara Geometry]->(label),
(599)-[:MilitaryCamp]->(type),
(599)-[:70d51242-571e-43ce-bd01-3bffca8cb4be_geom]->(hasGeometry),
(599)-[:Kohortenkastell]->(comment),
(599)-[:Kastell Feldioara]->(label),
(601)-[:Point]->(type),
(601)-[:4326> POINT (24.592319 47.096014)]->(asWKT),
(601)-[:Kastell Orheiul Bistriţei Geometry]->(label),
(604)-[:Point]->(type),
(604)-[:4326> POINT (20.585819 46.138106)]->(asWKT),
(604)-[:Kastell Cenad Geometry]->(label),
(607)-[:MilitaryCamp]->(type),
(607)-[:4e013c45-7445-4ea6-8356-2c9cc9e7ac6e_geom]->(hasGeometry),
(607)-[:Auxiliarkastell]->(comment),
(607)-[:Kastell Gilău]->(label),
(609)-[:MilitaryCamp]->(type),
(609)-[:b0cccdd1-2478-40bc-add2-a0e1bad88feb_geom]->(hasGeometry),
(609)-[:nan]->(comment),
(609)-[:Kastell Slăveni]->(label),
(611)-[:Point]->(type),
(611)-[:4326> POINT (23.157319 47.179167)]->(asWKT),
(611)-[:Kastelle von Porolissum Geometry]->(label),
(614)-[:MilitaryCamp]->(type),
(614)-[:80ce787b-1ab0-42e7-b03c-c641d3767774_geom]->(hasGeometry),
(614)-[:nan]->(comment),
(614)-[:Kastell Perisani]->(label),
(616)-[:Point]->(type),
(616)-[:4326> POINT (24.761056 44.307778)]->(asWKT),
(616)-[:Kastell Ghioca Geometry]->(label),
(619)-[:MilitaryCamp]->(type),
(619)-[:19360a61-a15a-4d56-a100-f3be57e93ff1_geom]->(hasGeometry),
(619)-[:nan]->(comment),
(619)-[:Kastell Mofleni (Pelendava)]->(label),
(621)-[:MilitaryCamp]->(type),
(621)-[:6689fc0e-01ff-4dbc-b3ed-49e35a3d397a_geom]->(hasGeometry),
(621)-[:nan]->(comment),
(621)-[:Kastell Bologa (Resculum)]->(label),
(623)-[:MilitaryCamp]->(type),
(623)-[:1e218e82-f264-4241-a8e0-5efd9a1ec8a4_geom]->(hasGeometry),
(623)-[:nan]->(comment),
(623)-[:Kastell Islaz-Razovica]->(label),
(625)-[:MilitaryCamp]->(type),
(625)-[:c3a471a8-ab67-4e9c-b127-1eff017b0cb4_geom]->(hasGeometry),
(625)-[:nan]->(comment),
(625)-[:Kastell Albota]->(label),
(627)-[:LegionaryCamp]->(type),
(627)-[:ffd99607-0513-4fa5-8073-c80bddbfab84_geom]->(hasGeometry),
(627)-[:Legionslager]->(comment),
(627)-[:Kastell Tibiscum]->(label),
(629)-[:Point]->(type),
(629)-[:4326> POINT (23.044569 47.048264)]->(asWKT),
(629)-[:Kastell Buciumi Geometry]->(label),
(632)-[:MilitaryCamp]->(type),
(632)-[:46e40ed7-3b02-4bb3-ba5c-8dcb5f55b990_geom]->(hasGeometry),
(632)-[:nan]->(comment),
(632)-[:Kastell Plesa]->(label),
(634)-[:MilitaryCamp]->(type),
(634)-[:5e33b468-4135-46b4-babc-99f5c423f966_geom]->(hasGeometry),
(634)-[:Kohortenkastell (?)]->(comment),
(634)-[:Kastell Szeged]->(label),
(636)-[:Point]->(type),
(636)-[:4326> POINT (23.391764 46.754058)]->(asWKT),
(636)-[:Kastell Gilău Geometry]->(label),
(639)-[:Point]->(type),
(639)-[:4326> POINT (22.924444 44.838889)]->(asWKT),
(639)-[:Kastell Cătunele Geometry]->(label),
(642)-[:LegionaryCamp]->(type),
(642)-[:7e6b0abd-392e-48da-a973-52db57e43459_geom]->(hasGeometry),
(642)-[:Legionslager]->(comment),
(642)-[:Kastell Berzovia ]->(label),
(644)-[:MilitaryCamp]->(type),
(644)-[:7cadca30-bfd9-4628-9916-c20eecafa356_geom]->(hasGeometry),
(644)-[:Kohortenkastell]->(comment),
(644)-[:Kastell Stolniceni]->(label),
(646)-[:GeometryCollection]->(type),
(646)-[:Point Instances Collection]->(label),
(646)-[:b0cccdd1-2478-40bc-add2-a0e1bad88feb_geom]->(member),
(646)-[:8fa245f8-ffe5-4e74-b259-410c7be91afd_geom]->(member),
(646)-[:322e89c0-f571-4be4-a08c-84b35efb69e5_geom]->(member),
(646)-[:707cb61a-d04e-4c7b-a620-6587db82f116_geom]->(member),
(646)-[:5e6a65c9-32dd-4581-b6ab-a95afdc4d061_geom]->(member),
(646)-[:fb3dfa9f-ac48-4ced-a8dc-2b635594cfdd_geom]->(member),
(646)-[:1795d125-e071-4153-b07e-e147bb19ad65_geom]->(member),
(646)-[:48f27058-f4ea-41f3-8319-888f59ffdd2d_geom]->(member),
(646)-[:4c745423-da08-4414-93b9-bf0df2382c76_geom]->(member),
(646)-[:5028c3bd-efbb-43b3-a8f6-a30ab9844d1b_geom]->(member),
(646)-[:51607531-4767-41c1-94ca-86d68572c7c2_geom]->(member),
(646)-[:58660c1d-c211-4cf7-90d6-b53a5957addc_geom]->(member),
(646)-[:64755b3a-9ff6-4c12-b9fb-778e3bde5b1f_geom]->(member),
(646)-[:71192446-c179-4a45-9214-44ef9a3a996b_geom]->(member),
(646)-[:78b044f5-8a10-47ed-acf0-74658affbf22_geom]->(member),
(646)-[:7e23ed9a-8efc-48ec-a294-a7cc9b8285dc_geom]->(member),
(646)-[:80943cf4-f263-44f2-bd49-2a2c405b3be6_geom]->(member),
(646)-[:8135cb6b-504d-4cae-9835-b9a7b0613163_geom]->(member),
(646)-[:88218e4a-aa6a-421c-84ea-a646790b80cb_geom]->(member),
(646)-[:8f964055-7a95-4e88-bcef-5bd3a5824de9_geom]->(member),
(646)-[:9f8f4e96-12d9-449b-b9ab-6e6080e34c9f_geom]->(member),
(646)-[:a41296e5-fca2-4ce3-843e-a17871a5d85b_geom]->(member),
(646)-[:b3e7d110-127b-45a7-9195-5e8a694e4862_geom]->(member),
(646)-[:c2b75037-aed0-49b4-9e1c-39944efa5cb4_geom]->(member),
(646)-[:c589a7d3-f71c-4051-ac8b-c701902d3610_geom]->(member),
(646)-[:c75941f8-009d-4c4c-8505-0298a88a6fd4_geom]->(member),
(646)-[:cb7b6f3a-395f-48b6-a6e3-247e6c5a2ff5_geom]->(member),
(646)-[:cfcfa4b0-501f-4563-8157-3c76054014a4_geom]->(member),
(646)-[:d0ef2a62-6c85-44ce-a995-65ab6d5a5f43_geom]->(member),
(646)-[:d151609e-cb90-4faf-a74b-54d2f52e01a1_geom]->(member),
(646)-[:d8bcb543-3948-43fd-937b-2782138b9deb_geom]->(member),
(646)-[:ec211670-f0d2-4c53-b8a5-3b8830b0aaa1_geom]->(member),
(646)-[:ed3e59f2-e683-4800-9e27-92d82cbc867f_geom]->(member),
(646)-[:ed6779f9-6afd-4f34-b7ff-0a6e731d4846_geom]->(member),
(688)-[:Point]->(type),
(688)-[:4326> POINT (24.983333 43.7345)]->(asWKT),
(688)-[:Kastell Flămănda (Poiana) Geometry]->(label),
(691)-[:Point]->(type),
(691)-[:4326> POINT (21.587219 45.265)]->(asWKT),
(691)-[:Kastell Surducul Mare Geometry]->(label),
(694)-[:MilitaryCamp]->(type),
(694)-[:64ae9ea8-9dca-4e22-b32b-c2f95fd80b44_geom]->(hasGeometry),
(694)-[:nan]->(comment),
(694)-[:Kastell Fâlfani]->(label),
(696)-[:Point]->(type),
(696)-[:4326> POINT (22.306831 45.168611)]->(asWKT),
(696)-[:Kastell Teregova (Ad Pannonios) Geometry]->(label),
(699)-[:Point]->(type),
(699)-[:4326> POINT (24.373611 45.173611)]->(asWKT),
(699)-[:Kastell Sămbotin (Castra Traiana) Geometry]->(label)
